...
type DiscordContractApiSurface = Pick<
  typeof import("@enclawed/discord/contract-api.js"),
  "listDiscordDirectoryPeersFromConfig" | "listDiscordDirectoryGroupsFromConfig"
>;
type DiscordProbe = import("@enclawed/discord/api.js").DiscordProbe;
type DiscordTokenResolution = import("@enclawed/discord/api.js").DiscordTokenResolution;
type IMessageProbe = import("@enclawed/imessage/runtime-api.js").IMessageProbe;
type SignalProbe = import("@enclawed/signal/api.js").SignalProbe;
type SlackContractApiSurface = Pick<
  typeof import("@enclawed/slack/contract-api.js"),
  "listSlackDirectoryPeersFromConfig" | "listSlackDirectoryGroupsFromConfig"
>;
type SlackProbe = import("@enclawed/slack/api.js").SlackProbe;
type TelegramContractApiSurface = Pick<
  typeof import("@enclawed/telegram/contract-api.js"),
  "listTelegramDirectoryPeersFromConfig" | "listTelegramDirectoryGroupsFromConfig"
>;
type TelegramProbe = import("@enclawed/telegram/api.js").TelegramProbe;
type TelegramTokenResolution = import("@enclawed/telegram/api.js").TelegramTokenResolution;
type WhatsAppApiSurface = typeof import("@enclawed/whatsapp/api.js");
...
async function listDirectoryEntriesWithDefaults(listFn: DirectoryListFn, cfg: EnclawedConfig) {
  return await listFn({
    cfg,
    accountId: "default",
    query: null,
