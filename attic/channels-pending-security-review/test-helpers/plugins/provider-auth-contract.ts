...
type LoginOpenAICodexOAuth =
  (typeof import("@enclawed/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("@enclawed/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("@enclawed/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("@enclawed/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("@enclawed/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/provider-auth-login")>(
    "@enclawed/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("@enclawed/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/provider-auth")>(
    "@enclawed/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
