...
const providerFilter = parseCsvFilter(process.env.ENCLAWED_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ENCLAWED_LIVE_MUSIC_GENERATION_MODELS);
