  ...
  return withEnvAsync(
    {
      ...
      ENCLAWED_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when ENCLAWED_VERSION is not set", async () => {
  ...
  it("prefers ENCLAWED_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over ENCLAWED_SERVICE_VERSION when ENCLAWED_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        ENCLAWED_VERSION: " ",
        ENCLAWED_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when ENCLAWED_VERSION and ENCLAWED_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        ENCLAWED_VERSION: " ",
        ENCLAWED_SERVICE_VERSION: "\t",
