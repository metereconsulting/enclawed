...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.enclawed.gateway"
    private static let nodeService = "ai.enclawed.node"
    private static let talkService = "ai.enclawed.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.enclawed.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.enclawed.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("enclawed-gateway.log")
    }
