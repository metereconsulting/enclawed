...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.enclawed.ios", category: "LiveActivity")
    private var currentActivity: Activity<EnclawedActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = EnclawedActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<EnclawedActivityAttributes>.activities
    ...
    private func updateCurrent(state: EnclawedActivityAttributes.ContentState) {
    ...
    private func connectingState() -> EnclawedActivityAttributes.ContentState {
        EnclawedActivityAttributes.ContentState(
    ...
    private func idleState() -> EnclawedActivityAttributes.ContentState {
        EnclawedActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> EnclawedActivityAttributes.ContentState {
        EnclawedActivityAttributes.ContentState(
