...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: EnclawedPhotosLatestParams) async throws -> EnclawedPhotosLatestPayload {
        ...
        var results: [EnclawedPhotoPayload] = []
        ...
        return EnclawedPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> EnclawedPhotoPayload
    {
