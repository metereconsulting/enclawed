...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "enclawed devices approve req-123",
            docsURLString: "https://docs.enclawed.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "enclawed devices approve req-123")
        #expect(error.docsURLString == "https://docs.enclawed.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "enclawed devices approve req-123")
    }
