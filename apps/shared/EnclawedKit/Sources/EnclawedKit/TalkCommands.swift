...
public enum EnclawedTalkCommand: String, Codable, Sendable {
...
public struct EnclawedTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct EnclawedTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
