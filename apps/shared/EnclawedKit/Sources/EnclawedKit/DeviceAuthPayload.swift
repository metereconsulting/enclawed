...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: EnclawedProtocol.AnyCodable]?
    {
        ...
        return [
            "id": EnclawedProtocol.AnyCodable(identity.deviceId),
            "publicKey": EnclawedProtocol.AnyCodable(publicKey),
            "signature": EnclawedProtocol.AnyCodable(signature),
            "signedAt": EnclawedProtocol.AnyCodable(signedAtMs),
            "nonce": EnclawedProtocol.AnyCodable(nonce),
        ]
    }
}
