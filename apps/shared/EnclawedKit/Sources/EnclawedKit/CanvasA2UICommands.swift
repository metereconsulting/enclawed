...
public enum EnclawedCanvasA2UICommand: String, Codable, Sendable {
...
public struct EnclawedCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct EnclawedCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
