...
public struct EnclawedChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct EnclawedChatSessionsDefaults: Codable, Sendable {
...
public struct EnclawedChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct EnclawedChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: EnclawedChatSessionsDefaults?
    public let sessions: [EnclawedChatSessionEntry]
    ...
    public init(
        ...
        sessions: [EnclawedChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
