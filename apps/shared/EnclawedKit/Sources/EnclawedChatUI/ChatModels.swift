...
public typealias EnclawedPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias EnclawedPlatformImage = UIImage
#endif

public struct EnclawedChatUsageCost: Codable, Hashable, Sendable {
...
public struct EnclawedChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: EnclawedChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(EnclawedChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct EnclawedChatMessageContent: Codable, Hashable, Sendable {
...
public struct EnclawedChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [EnclawedChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: EnclawedChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [EnclawedChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: EnclawedChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(EnclawedChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([EnclawedChatMessageContent].self, forKey: .content) {
...
public struct EnclawedChatHistoryPayload: Codable, Sendable {
...
public struct EnclawedSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct EnclawedSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [EnclawedSessionPreviewItem]
}

public struct EnclawedSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [EnclawedSessionPreviewEntry]

    public init(ts: Int, previews: [EnclawedSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct EnclawedChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct EnclawedChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct EnclawedAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct EnclawedChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct EnclawedGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct EnclawedPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: EnclawedPlatformImage?
...
public struct EnclawedChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
