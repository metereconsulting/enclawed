...
enum UIStrings {
    static let welcomeTitle = "Welcome to Enclawed"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "enclawed.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: EnclawedChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g enclawed@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: EnclawedChatViewModel(
