...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.enclawed", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Enclawed/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__enclawed__/a2ui/").absoluteString + "?platform=macos"
    }
