...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = EnclawedConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = EnclawedConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: EnclawedConfigFile.loadDict(),
        ...
        EnclawedConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/enclawed"
        state.remoteCliPath = ""
        return state
    }
}
