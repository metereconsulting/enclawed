...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.enclawed", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Enclawed windows, but below the system’s pop-up menus.
