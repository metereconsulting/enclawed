...
/// Menu contents for the Enclawed menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Enclawed") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Enclawed Not Configured"
        case .remote:
            "Remote Enclawed Active"
        case .local:
            "Enclawed Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .enclawedSelectSettingsTab, object: tab)
        }
    }
