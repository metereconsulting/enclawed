...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.enclawed", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.enclawed", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [EnclawedChatMessage] = messages.compactMap { item in
