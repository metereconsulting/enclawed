...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case EnclawedBrowserCommand.proxy.rawValue:
            ...
            case EnclawedLocationCommand.get.rawValue:
            ...
            case EnclawedSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case EnclawedSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case EnclawedSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case EnclawedSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case EnclawedSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case EnclawedCanvasA2UICommand.push.rawValue,
             EnclawedCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard EnclawedConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: EnclawedNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__enclawed__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(EnclawedSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(EnclawedSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: EnclawedSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> EnclawedLocationMode {
        ...
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: EnclawedNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: EnclawedCanvasSnapshotFormat,
        maxWidth: Int?,
