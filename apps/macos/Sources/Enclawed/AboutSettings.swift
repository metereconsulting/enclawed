...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/enclawed/enclawed") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/enclawed/enclawed")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://enclawed.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "EnclawedBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "EnclawedBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "EnclawedGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "EnclawedGitCommit") as? String) ??
            "unknown"
    }
