...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.enclawed", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".enclawed/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.enclawedCommand(
            subcommand: "gateway",
