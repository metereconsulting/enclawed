...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .enclawedSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? EnclawedPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? EnclawedPaths.stateDirURL.path
...
extension Notification.Name {
    static let enclawedSelectSettingsTab = Notification.Name("enclawedSelectSettingsTab")
}
