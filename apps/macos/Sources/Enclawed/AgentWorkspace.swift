...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.enclawed", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return EnclawedConfigFile.defaultWorkspaceURL() }
