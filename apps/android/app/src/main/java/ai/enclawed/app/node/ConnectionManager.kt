...
import ai.enclawed.app.gateway.GatewayClientInfo
import ai.enclawed.app.gateway.GatewayConnectOptions
import ai.enclawed.app.gateway.GatewayEndpoint
import ai.enclawed.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "EnclawedAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "enclawed-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "enclawed-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
  }
