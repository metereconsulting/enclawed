...
import ai.enclawed.app.ui.mobileAccentBorderStrong
...
import ai.enclawed.app.ui.mobileSurface
import ai.enclawed.app.ui.mobileText
import ai.enclawed.app.ui.mobileTextSecondary
import ai.enclawed.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.enclawed.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.enclawed.app.ui.mobileFontFamily,
