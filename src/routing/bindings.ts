...
export function listBindings(cfg: EnclawedConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: EnclawedConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: EnclawedConfig) {
