...
type PluginEntriesConfig = NonNullable<NonNullable<EnclawedConfig["plugins"]>["entries"]>;
...
// ENCLAWED_API_KEY authenticates the local Enclawed bridge itself and must
