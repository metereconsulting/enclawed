...
export function listAuthProfileStorePaths(config: EnclawedConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: EnclawedConfig, stateDir: string): string[] {
