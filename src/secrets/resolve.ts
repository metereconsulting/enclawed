...
function resolveResolutionLimits(config: EnclawedConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: EnclawedConfig): SecretProviderConfig {
