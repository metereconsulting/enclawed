...
vi.mock("../../infra/enclawed-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/enclawed-root.js")>(
    "../../infra/enclawed-root.js",
  );
  return {
    ...actual,
    resolveEnclawedPackageRoot: async () => "/tmp/enclawed",
  };
});
