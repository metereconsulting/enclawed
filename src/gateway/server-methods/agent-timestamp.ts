 ...
 *
 * @see https://github.com/enclawed/enclawed/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an EnclawedConfig.
 */
export function timestampOptsFromConfig(cfg: EnclawedConfig): TimestampInjectionOptions {
  return {
