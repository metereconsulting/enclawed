...
import type { ConfigValidationIssue, EnclawedConfig } from "../../config/types.enclawed.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: EnclawedConfig; schema: ConfigSchemaResponse } | null {
...
function didSharedGatewayAuthChange(prev: EnclawedConfig, next: EnclawedConfig): boolean {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadEnclawedPlugins() (called inside
