...
describe("gateway auth", () => {
  ...
  it("resolves token/password from ENCLAWED gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          ENCLAWED_GATEWAY_TOKEN: "env-token",
          ENCLAWED_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides ENCLAWED_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        ENCLAWED_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
