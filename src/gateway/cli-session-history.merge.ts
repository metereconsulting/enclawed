...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__enclawed" in message &&
    (message as { __enclawed?: unknown }).__enclawed &&
    typeof (message as { __enclawed?: unknown }).__enclawed === "object"
      ? ((message as { __enclawed?: Record<string, unknown> }).__enclawed ?? {})
      : undefined;
