...
export function hasAmbiguousGatewayAuthModeConfig(cfg: EnclawedConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: EnclawedConfig): void {
