...
export function collectConfiguredModelPricingRefs(config: EnclawedConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: EnclawedConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
