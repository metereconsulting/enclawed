...
export function resolveEnclawedManifestBlock(params: {
  frontmatter: Record<string, unknown>;
  key?: string;
...
export function resolveEnclawedManifestRequires(
  metadataObj: Record<string, unknown>,
): EnclawedManifestRequires | undefined {
  const requiresRaw =
...
export function resolveEnclawedManifestInstall<T>(
  metadataObj: Record<string, unknown>,
...
export function resolveEnclawedManifestOs(metadataObj: Record<string, unknown>): string[] {
...
export function parseEnclawedManifestInstallBase(
  input: unknown,
  allowedKinds: readonly string[],
): ParsedEnclawedManifestInstallBase | undefined {
  ...
  const spec: ParsedEnclawedManifestInstallBase = {
    raw,
    kind,
  };
...
export function applyEnclawedManifestInstallCommonFields<
