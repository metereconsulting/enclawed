...
function hasConfiguredAuthProfiles(cfg: EnclawedConfig): boolean {
  return (
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: EnclawedConfig = {
    ...input.cfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ENCLAWED_TEST_FAST === "1";
