...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.ENCLAWED_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.ENCLAWED_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.ENCLAWED_SERVICE_MARKER = originalServiceMarker;
    }
  });
