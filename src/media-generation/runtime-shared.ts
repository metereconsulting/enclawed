...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: EnclawedConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: EnclawedConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: EnclawedConfig;
  agentDir?: string;
  listProviders: (cfg?: EnclawedConfig) => CapabilityProviderCandidate[];
}): string[] {
