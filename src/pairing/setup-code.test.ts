...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("ENCLAWED_GATEWAY_TOKEN", "");
    vi.stubEnv("ENCLAWED_GATEWAY_PASSWORD", "");
    vi.stubEnv("ENCLAWED_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses ENCLAWED_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          ENCLAWED_GATEWAY_TOKEN: "new-token",
        },
