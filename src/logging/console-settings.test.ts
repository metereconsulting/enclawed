...
let originalEnclawedTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalEnclawedTestConsole = process.env.ENCLAWED_TEST_CONSOLE;
  process.env.ENCLAWED_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalEnclawedTestConsole === undefined) {
    delete process.env.ENCLAWED_TEST_CONSOLE;
  } else {
    process.env.ENCLAWED_TEST_CONSOLE = originalEnclawedTestConsole;
  }
