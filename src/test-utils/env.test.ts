...
describe("env test utils", () => {
  ...
  it("createPathResolutionEnv clears leaked path overrides before applying explicit ones", () => {
    ...
    const previousOpenClawHome = process.env.ENCLAWED_HOME;
    const previousStateDir = process.env.ENCLAWED_STATE_DIR;
    const previousBundledDir = process.env.ENCLAWED_BUNDLED_PLUGINS_DIR;
    process.env.ENCLAWED_HOME = "/srv/openclaw-home";
    process.env.ENCLAWED_STATE_DIR = "/srv/openclaw-state";
    process.env.ENCLAWED_BUNDLED_PLUGINS_DIR = "/srv/openclaw-bundled";
    ...
    try {
      ...
      restoreEnvKey("ENCLAWED_HOME", previousOpenClawHome);
    ...
    try {
      const seen = withPathResolutionEnv(
        ...
        (env) => ({
          ...
          processOpenClawHome: process.env.ENCLAWED_HOME,
      ...
      expect(process.env.ENCLAWED_HOME).toBe("/srv/openclaw-home");
    } finally {
      restoreEnvKey("ENCLAWED_HOME", previousOpenClawHome);
    }
  });
