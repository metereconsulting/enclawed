...
describe("debug proxy runtime", () => {
  const envKeys = [
    ...
    "ENCLAWED_DEBUG_PROXY_SOURCE_PROCESS",
  ] as const;
  ...
  beforeEach(() => {
    ...
    process.env.ENCLAWED_DEBUG_PROXY_DB_PATH = "/tmp/openclaw-proxy-runtime-test.sqlite";
    process.env.ENCLAWED_DEBUG_PROXY_BLOB_DIR = "/tmp/openclaw-proxy-runtime-test-blobs";
    process.env.ENCLAWED_DEBUG_PROXY_SESSION_ID = "runtime-test-session";
    process.env.ENCLAWED_DEBUG_PROXY_SOURCE_PROCESS = "runtime-test";
  });
