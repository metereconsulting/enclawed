...
describe("debug proxy runtime", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ENCLAWED_DEBUG_PROXY_DB_PATH = "/tmp/enclawed-proxy-runtime-test.sqlite";
    process.env.ENCLAWED_DEBUG_PROXY_BLOB_DIR = "/tmp/enclawed-proxy-runtime-test-blobs";
