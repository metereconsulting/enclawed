...
function buildNoImageGenerationModelConfiguredMessage(cfg: EnclawedConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: EnclawedConfig }) {
