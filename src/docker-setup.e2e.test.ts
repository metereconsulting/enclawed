...
function createEnv(
  ...
  const env: NodeJS.ProcessEnv = {
    ...
    ENCLAWED_WORKSPACE_DIR: join(sandbox.rootDir, "openclaw"),
  };
...
describe("scripts/docker/setup.sh", () => {
  ...
  it("handles env defaults, home-volume mounts, and Docker build args", async () => {
    ...
    const result = runDockerSetup(activeSandbox, {
      ...
      ENCLAWED_HOME_VOLUME: "openclaw-home",
    });
    ...
    expect(envFile).toContain("ENCLAWED_HOME_VOLUME=openclaw-home"); // pragma: allowlist secret
