      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["enclawed gateway run", "Run the gateway in the foreground."],
            ["enclawed gateway status", "Show service status and probe reachability."],
            ["enclawed gateway discover", "Find local and wide-area gateway beacons."],
            ["enclawed gateway call health", "Call a gateway RPC method directly."],
