...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ENCLAWED_STATE_DIR = "/tmp/openclaw-cli-state";
    process.env.ENCLAWED_CONFIG_PATH = "/tmp/openclaw-cli-state/openclaw.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        ENCLAWED_STATE_DIR: "/tmp/openclaw-daemon-state",
        ENCLAWED_CONFIG_PATH: "/tmp/openclaw-daemon-state/openclaw.json",
