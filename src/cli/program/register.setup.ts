...
export function registerSetupCommand(program: Command) {
  program
    .command("setup")
    .description("Initialize the active Enclawed config and agent workspace")
    .addHelpText(
      "after",
      () =>
    ...
    .option(
      "--workspace <dir>",
      "Agent workspace directory (default: ~/.enclawed/workspace; stored as agents.defaults.workspace)",
    )
