...
${formatHelpExamples([
  ...
  [
    'enclawed message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'enclawed message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.enclawed.ai/cli/message")}`,
    )
    .action(() => {
