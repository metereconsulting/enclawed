...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.enclawed.ai/cli/agent")}`,
    )
    .action(async (opts) => {
      const verboseLevel =
...
${formatHelpExamples([
  ...
  [
    "enclawed agents set-identity --identity-file ~/.enclawed/workspace/IDENTITY.md --agent main",
