...
export const DEFAULT_CLI_NAME = "enclawed";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "enclawed"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(enclawed|enclawed)\b/;
