...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: EnclawedConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: EnclawedConfig, mode: ChannelAuthMode): string {
