    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["enclawed directory self --channel slack", "Show the connected account identity."],
          [
            'enclawed directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["enclawed directory groups list --channel discord", "List available groups/channels."],
          [
            "enclawed directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.enclawed.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
