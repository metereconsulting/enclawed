...
export type ReplyPayload = {
  ...
  /**
   * Structured presentation blocks (buttons, selects, context, dividers) for
   * channels that render rich interactive messages natively.
   */
  presentation?: MessagePresentation;
  /** Delivery-side directives such as pinning. */
