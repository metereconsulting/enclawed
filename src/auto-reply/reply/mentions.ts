...
function resolveMentionPatterns(cfg: EnclawedConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: EnclawedConfig | undefined, agentId?: string): RegExp[] {
