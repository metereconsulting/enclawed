...
function resolveAcpStreamCoalesceIdleMs(cfg: EnclawedConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: EnclawedConfig): number {
...
export function resolveAcpProjectionSettings(cfg: EnclawedConfig): AcpProjectionSettings {
