...
export type ReplyDispatcherWithTypingOptions = Omit<ReplyDispatcherOptions, "onIdle"> & {
  ...
  onCleanup?: () => void;
  /**
   * Optional payload transform applied immediately before each delivery. Use
   * this for channel-side last-mile rewrites (e.g. attaching delivery metadata)
   * without changing the dispatcher's normalization pipeline.
   */
  beforeDeliver?: (payload: ReplyPayload) => Promise<ReplyPayload> | ReplyPayload;
};
