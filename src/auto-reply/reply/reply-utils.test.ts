...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\benclawed\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "Enclawed",
          provider: "anthropic",
          model: "claude-opus-4-6",
          thinkingLevel: "high",
        },
        expected: "[Enclawed] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;
