...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "enclawed.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Enclawed out-of-band. Treat it as authoritative metadata about the current message context.",
