...
import { getRuntimeConfigSnapshot, type EnclawedConfig } from "../../config/config.js";
import {
...
export function resolveQueuedReplyRuntimeConfig(config: EnclawedConfig): EnclawedConfig {
  return (
