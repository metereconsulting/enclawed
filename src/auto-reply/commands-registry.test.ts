...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@enclawed", { botUsername: "enclawed" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@enclawed args", {
        botUsername: "enclawed",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@enclawed: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "enclawed" })).toBe(
      "/help@otherbot",
    );
  });
