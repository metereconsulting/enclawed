...
function makeCatalogEntry(
  ...
  return {
    ...
    install: overrides.install ?? { npmSpec: `@enclawed/${id}` },
  };
}
...
const resolveAgentWorkspaceDir = vi.hoisted(() =>
  vi.fn((_cfg?: unknown, _agentId?: unknown) => "/tmp/enclawed-workspace"),
);
