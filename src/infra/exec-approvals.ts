...
export type ExecApprovalRequestPayload = {
  ...
  commandPreview?: string | null;
  commandArgv?: string[];
  /** Optional UI-safe warning text surfaced alongside the approval prompt. */
...
const DEFAULT_SOCKET = "~/.enclawed/exec-approvals.sock";
const DEFAULT_FILE = "~/.enclawed/exec-approvals.json";
