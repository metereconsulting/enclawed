...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: EnclawedConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: EnclawedConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: EnclawedConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: EnclawedConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: EnclawedConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: EnclawedConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: EnclawedConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: EnclawedConfig;
    accountId: string;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: EnclawedConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
