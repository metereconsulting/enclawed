...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: EnclawedConfig): string | undefined {
  ...
  function listAccountIds(cfg: EnclawedConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: EnclawedConfig): string {
