...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: EnclawedConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: EnclawedConfig }>(
  collector: WarningCollector<{ cfg: EnclawedConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: EnclawedConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: EnclawedConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: EnclawedConfig },
>(
  projectCfg: (cfg: EnclawedConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: EnclawedConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: EnclawedConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: EnclawedConfig },
>(params: {
  providerConfigPresent: (cfg: EnclawedConfig) => boolean;
