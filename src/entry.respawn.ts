...
export const ENCLAWED_NODE_OPTIONS_READY = "ENCLAWED_NODE_OPTIONS_READY";
export const ENCLAWED_NODE_EXTRA_CA_CERTS_READY = "ENCLAWED_NODE_EXTRA_CA_CERTS_READY";
...
export function buildCliRespawnPlan(
  ...
  if (shouldSkipRespawnForArgv(argv) || isTruthyEnvValue(env.ENCLAWED_NO_RESPAWN)) {
    return null;
  }
  ...
  if (
    ...
    !isTruthyEnvValue(env[ENCLAWED_NODE_EXTRA_CA_CERTS_READY]) &&
  ...
  if (
    !isTruthyEnvValue(env[ENCLAWED_NODE_OPTIONS_READY]) &&
