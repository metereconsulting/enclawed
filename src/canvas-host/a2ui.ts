...
export const A2UI_PATH = "/__enclawed__/a2ui";

export const CANVAS_HOST_PATH = "/__enclawed__/canvas";

export const CANVAS_WS_PATH = "/__enclawed__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.enclawedCanvasA2UIAction.postMessage(...)
  // - Android: window.enclawedCanvasA2UIAction.postMessage(...)
  const handlerNames = ["enclawedCanvasA2UIAction"];
  ...
  globalThis.Enclawed = globalThis.Enclawed ?? {};
  globalThis.Enclawed.postMessage = postToNode;
  globalThis.Enclawed.sendUserAction = sendUserAction;
  globalThis.enclawedPostMessage = postToNode;
  globalThis.enclawedSendUserAction = sendUserAction;
