/**
 * Standalone MCP server that exposes Enclawed plugin-registered tools
...
function resolveTools(config: EnclawedConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "enclawed-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
