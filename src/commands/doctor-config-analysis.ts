...
import { EnclawedSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: EnclawedConfig): {
  config: EnclawedConfig;
  removed: string[];
} {
  const parsed = EnclawedSchema.safeParse(config);
  if (parsed.success) {
...
export function noteOpencodeProviderOverrides(cfg: EnclawedConfig): void {
