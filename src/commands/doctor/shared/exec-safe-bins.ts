...
function collectExecSafeBinScopes(cfg: EnclawedConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: EnclawedConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: EnclawedConfig): {
