...
function hasChannels(cfg: EnclawedConfig): boolean {
  return hasRecord(cfg.channels);
}

function hasPlugins(cfg: EnclawedConfig): boolean {
  return hasRecord(cfg.plugins);
}

function hasPluginLoadPaths(cfg: EnclawedConfig): boolean {
...
function hasExplicitChannelPluginBlockerConfig(cfg: EnclawedConfig): boolean {
...
function hasConfiguredSafeBins(cfg: EnclawedConfig): boolean {
