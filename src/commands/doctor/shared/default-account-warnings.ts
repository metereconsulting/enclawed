...
export function collectMissingDefaultAccountBindingWarnings(cfg: EnclawedConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: EnclawedConfig): string[] {
  const warnings: string[] = [];
