...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://enclawed.local")).toBe("https://enclawed.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://enclawed.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: enclawed security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://enclawed.local" },
      ...
      { Item: "Security", Value: "Run: enclawed security audit --deep" },
