...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set ENCLAWED_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `enclawed dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Enclawed.");
  } else if (hint) {
    runtime.log(hint);
  }
}
