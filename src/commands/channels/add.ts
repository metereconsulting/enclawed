...
import { replaceConfigFile, type EnclawedConfig } from "../../config/config.js";
...
async function resolveCatalogChannelEntry(raw: string, cfg: EnclawedConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as EnclawedConfig;
  ...
  // May trigger loadEnclawedPlugins on cache miss (disk scan + jiti import)
