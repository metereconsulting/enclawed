...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: EnclawedConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: EnclawedConfig, deps?: BrowserDoctorDeps) {
  try {
