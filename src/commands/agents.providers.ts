...
function resolveDefaultAccountId(cfg: EnclawedConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: EnclawedConfig): boolean {
...
export function summarizeBindings(cfg: EnclawedConfig, bindings: AgentBinding[]): string[] {
