...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: EnclawedConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: EnclawedConfig): Promise<void> {
