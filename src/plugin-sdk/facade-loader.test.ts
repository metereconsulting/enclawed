...
const FACADE_LOADER_GLOBAL = "__enclawedTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("enclawed-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("enclawed-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("enclawed-facade-loader-ids-", "identity-check");
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("enclawed-facade-loader-windows-dist-");
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("enclawed-facade-loader-circular-");
    process.env.ENCLAWED_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("enclawed-facade-loader-throw-");
    process.env.ENCLAWED_BUNDLED_PLUGINS_DIR = dir;
