...
//
// Re-exports a subset of the upstream test-fixtures surface. Lines that
// referenced upstream-only helpers (./test-helpers/sandbox-fixtures.js) are
// omitted because no bundled oss extension imports them — adding them
// would only drag closed-tree deps into the runtime build.
