...
export { resolveEnclawedAgentDir } from "../agents/agent-paths.js";
export {
...
export { hasUsableOAuthCredential } from "../agents/auth-profiles/external-cli-sync.js";
...
export function listUsableProviderAuthProfileIds(params: {
  ...
  try {
    const agentDir = params.agentDir?.trim() || resolveEnclawedAgentDir();
    const store = ensureAuthProfileStore(agentDir, {
      allowKeychainPrompt: false,
    });
    return {
