...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: EnclawedConfig) => string | undefined;
  ...
  resolveTtsConfig: (cfg: EnclawedConfig) => ResolvedTtsConfig;
  resolveTtsPrefsPath: (config: ResolvedTtsConfig) => string;
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: EnclawedConfig) => TtsProvider[];
