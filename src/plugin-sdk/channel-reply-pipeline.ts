...
import type { SourceReplyDeliveryMode as _SourceReplyDeliveryMode } from "../auto-reply/get-reply-options.types.js";

export function resolveChannelSourceReplyDeliveryMode(params: {
  cfg: import("../config/types.enclawed.js").EnclawedConfig;
  ctx: SourceReplyDeliveryModeContext;
  requested?: _SourceReplyDeliveryMode;
  messageToolAvailable?: boolean;
}): _SourceReplyDeliveryMode {
