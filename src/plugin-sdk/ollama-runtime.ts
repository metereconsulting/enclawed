type FacadeModule = typeof import("@enclawed/ollama/runtime-api.js");
...
export type OllamaEmbeddingClient = import("@enclawed/ollama/runtime-api.js").OllamaEmbeddingClient;
