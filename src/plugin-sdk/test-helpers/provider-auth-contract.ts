...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("@enclawed/plugin-sdk/provider-auth-login", async () => {
      const actual = await vi.importActual<
        typeof import("@enclawed/plugin-sdk/provider-auth-login")
    ...
    vi.doMock("@enclawed/plugin-sdk/provider-auth", async () => {
