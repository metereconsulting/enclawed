...
export function applyGoogleGeminiModelDefault(cfg: EnclawedConfig): {
  next: EnclawedConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: EnclawedConfig): EnclawedConfig {
...
export function applyOpenAIConfig(cfg: EnclawedConfig): EnclawedConfig {
...
export function applyOpencodeGoModelDefault(cfg: EnclawedConfig): {
  next: EnclawedConfig;
  changed: boolean;
} {
