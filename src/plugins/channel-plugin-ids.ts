...
function resolveGatewayStartupDreamingPluginIds(config: EnclawedConfig): Set<string> {
...
function resolveExplicitMemorySlotStartupPluginId(config: EnclawedConfig): string | undefined {
