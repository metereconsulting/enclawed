...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveEnclawedAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: EnclawedConfig): SecretRef {
