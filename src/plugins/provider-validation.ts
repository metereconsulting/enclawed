import { checkProvider } from "../enclawed/policy.js";
...
export function normalizeRegisteredProvider(params: {
  ...
  // enclawed: deny providers that are not on the policy allowlist (skipped in
  // open flavor where enforceAllowlists=false), and reject any provider
