...
export function applyProviderAuthConfigPatch(cfg: EnclawedConfig, patch: unknown): EnclawedConfig {
...
export function applyDefaultModel(cfg: EnclawedConfig, model: string): EnclawedConfig {
