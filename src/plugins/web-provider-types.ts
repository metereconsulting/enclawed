...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: EnclawedConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: EnclawedConfig, value: unknown) => void;
  applySelectionConfig?: (config: EnclawedConfig) => EnclawedConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => EnclawedConfig | Promise<EnclawedConfig>;
