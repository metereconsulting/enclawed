...
export function expectCodexMissingAuthHint(
  ...
  expectedModelRef = "openai-codex/gpt-5.4",
) {
  expect(
...
// gpt-5.5-renamed aliases for upstream contract tests. The oss catalog name
// uses the post-rename id; legacy contract suites bound under the
// "WithGpt55" name still need a stable export to import.
