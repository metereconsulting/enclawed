...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: EnclawedConfig; sessionKey: string }): AcpSessionResolution {
  ...
  private resolveTurnTimeoutMs(params: { cfg: EnclawedConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: EnclawedConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: EnclawedConfig }): Promise<void> {
