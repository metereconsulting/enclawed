...
export function isAcpEnabledByPolicy(cfg: EnclawedConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: EnclawedConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: EnclawedConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: EnclawedConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: EnclawedConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: EnclawedConfig, agentId: string): boolean {
