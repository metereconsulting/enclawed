...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof EnclawedConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: EnclawedConfig; env: NodeJS.ProcessEnv }): {
  cfg: EnclawedConfig;
  changes: string[];
} {
