...
export function resolveSubagentToolPolicy(cfg?: EnclawedConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: EnclawedConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: EnclawedConfig["tools"];
