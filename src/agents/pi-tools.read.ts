...
function resolveAdaptiveReadMaxBytes(options?: EnclawedReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createEnclawedReadTool(base, {
...
export function createEnclawedReadTool(
  base: AnyAgentTool,
  options?: EnclawedReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
