...
export function resolveAgentModelPrimary(cfg: EnclawedConfig, agentId: string): string | undefined {
...
function findMutableAgentEntry(cfg: EnclawedConfig, agentId: string): AgentConfig | undefined {
