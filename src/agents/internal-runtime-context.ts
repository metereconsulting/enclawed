export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_ENCLAWED_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_ENCLAWED_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[ENCLAWED_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[ENCLAWED_INTERNAL_CONTEXT_END]]";
