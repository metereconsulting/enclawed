...
async function resolveContext(config: EnclawedConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): EnclawedConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
