...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<EnclawedConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<EnclawedConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: EnclawedConfig): WebSearchConfig {
