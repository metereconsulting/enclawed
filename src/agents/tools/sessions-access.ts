...
export function resolveSessionToolsVisibility(cfg: EnclawedConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: EnclawedConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: EnclawedConfig): AgentToAgentPolicy {
