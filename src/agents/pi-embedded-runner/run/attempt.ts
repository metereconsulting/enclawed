...
import { resolveEnclawedDocsPath } from "../../docs-path.js";
...
import { createEnclawedCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/enclawed/enclawed/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("enclawed:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/enclawed/enclawed/issues/8643
