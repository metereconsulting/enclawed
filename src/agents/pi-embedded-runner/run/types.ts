...
export type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  /**
   * Optional resolved runtime plan describing the harness/auth/transport choices
   * for this attempt. When present, harnesses consult the plan instead of
   * re-deriving auth/transport/transcript policy on every turn.
   */
...
export type EmbeddedRunAttemptResult = {
  ...
  /** Heartbeat tool response captured during this attempt, when emitted. */
  heartbeatToolResponse?: import("../../../auto-reply/heartbeat-tool-response.js").HeartbeatToolResponse;
  ...
  /**
   * Set by harness adapters when a terminal turn produced no visible reply.
   *
   * Drives the format-class fallback classification surfaced through
