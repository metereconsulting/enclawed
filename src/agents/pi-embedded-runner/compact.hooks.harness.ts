...
export const createEnclawedCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createEnclawedCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveEnclawedDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveEnclawedAgentDir: vi.fn(() => "/tmp"),
  }));
