...
export async function planEnclawedModelsJsonWithDeps(
  params: {
    cfg: EnclawedConfig;
...
export async function planEnclawedModelsJson(
  params: Parameters<typeof planEnclawedModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planEnclawedModelsJsonWithDeps(params);
}
