...
export const DEFAULT_SANDBOX_IMAGE = "enclawed-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "enclawed-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "enclawed-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "enclawed-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "enclawed-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "enclawed-sandbox-browser";
