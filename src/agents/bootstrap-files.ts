...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "enclawed:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: EnclawedConfig): AgentContextInjection {
