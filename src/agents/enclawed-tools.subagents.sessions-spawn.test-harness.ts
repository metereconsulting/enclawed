...
export type CreateEnclawedToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateEnclawedToolsOpts) {
...
vi.mock("../config/sessions.js", async () => {
  ...
  return {
    ...
    resolveStorePath: () => "/tmp/enclawed-sessions-spawn-test-store.json",
