...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.ENCLAWED_BUNDLED_PLUGINS_DIR;
  delete env.ENCLAWED_SKIP_PROVIDERS;
  delete env.ENCLAWED_SKIP_CHANNELS;
  delete env.ENCLAWED_SKIP_CRON;
  delete env.ENCLAWED_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
