...
function isValidMiddlewareToolResult(value: unknown): value is EnclawedAgentToolResult {
...
function buildMiddlewareFailureResult(): EnclawedAgentToolResult {
  return {
    content: [
      {
        type: "text",
...
export function createAgentToolResultMiddlewareRunner(
  ...
  return {
    ...
    ): Promise<EnclawedAgentToolResult> {
