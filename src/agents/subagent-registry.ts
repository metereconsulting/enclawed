...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: EnclawedConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: EnclawedConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: EnclawedConfig, runTimeoutSeconds?: number) {
