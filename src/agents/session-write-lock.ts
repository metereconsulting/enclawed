...
const CLEANUP_STATE_KEY = Symbol.for("enclawed.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("enclawed.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("enclawed.sessionWriteLockWatchdogState");
