...
export function isConfigPathTruthy(config: EnclawedConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["enclawed-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: EnclawedConfig): string[] | undefined {
