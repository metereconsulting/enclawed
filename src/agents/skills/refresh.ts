...
function resolveWatchPaths(workspaceDir: string, config?: EnclawedConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: EnclawedConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: EnclawedConfig }) {
