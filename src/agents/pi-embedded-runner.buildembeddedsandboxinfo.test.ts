...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/enclawed-sandbox",
    agentWorkspaceDir: "/tmp/enclawed-workspace",
    workspaceAccess: "none",
    runtimeId: "enclawed-sbx-test",
    runtimeLabel: "enclawed-sbx-test",
    containerName: "enclawed-sbx-test",
    ...
    browser: {
      ...
      containerName: "enclawed-sbx-browser-test",
    },
