...
function asEnclawedConfig(value: unknown): EnclawedConfig | undefined {
  return value !== null && typeof value === "object" && !Array.isArray(value)
    ? (value as EnclawedConfig)
    : undefined;
}
...
export function buildAgentRuntimeDeliveryPlan(
  ...
  return {
    ...
    resolveFollowupRoute() {
      // Plugin-driven followup fallback routing is not currently wired through
      // provider-runtime. Returning undefined defers to the caller's defaults.
      return undefined;
    },
  };
}
