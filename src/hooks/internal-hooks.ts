/**
 * Hook system for Enclawed agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("enclawed.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("enclawed.internalHooksEnabled");
