...
describe("plugin activation boundary", () => {
  ...
  let browserHelpersPromise:
    | Promise<{
        ...
        DEFAULT_ENCLAWED_BROWSER_COLOR: typeof import("./plugin-sdk/browser-config.js").DEFAULT_ENCLAWED_BROWSER_COLOR;
        DEFAULT_ENCLAWED_BROWSER_PROFILE_NAME: typeof import("./plugin-sdk/browser-config.js").DEFAULT_ENCLAWED_BROWSER_PROFILE_NAME;
  ...
  function importBrowserHelpers() {
    browserHelpersPromise ??= Promise.all([
      ...
      DEFAULT_ENCLAWED_BROWSER_COLOR: config.DEFAULT_ENCLAWED_BROWSER_COLOR,
      DEFAULT_ENCLAWED_BROWSER_PROFILE_NAME: config.DEFAULT_ENCLAWED_BROWSER_PROFILE_NAME,
  ...
  it("keeps generic boundaries cold and loads only narrow browser helper surfaces on use", async () => {
    ...
    expect(browser.DEFAULT_ENCLAWED_BROWSER_COLOR).toBe("#FF4500");
    expect(browser.DEFAULT_ENCLAWED_BROWSER_PROFILE_NAME).toBe("enclawed");
    ...
    expect(browser.resolveProfile(resolved, "enclawed")).toEqual(
