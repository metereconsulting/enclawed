...
export type EnclawedConfig = {
  meta?: {
    /** Last Enclawed version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Enclawed UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const enclawedConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = EnclawedConfig & {
  readonly [enclawedConfigStateBrand]?: TState;
};
