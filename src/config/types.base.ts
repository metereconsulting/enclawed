...
export type ChannelStreamingPreviewConfig = {
  ...
  /**
   * Render tool progress chunks in the preview surface as the agent runs
   * tools. Default: true. Channels can set this to false to keep previews
   * limited to assistant text only.
   */
...
export type SessionConfig = {
   ...
   * If parent totalTokens is above this value, Enclawed skips parent fork and
...
export type WebConfig = {
  ...
  /** Baileys WhatsApp Web socket timing overrides. */
  whatsapp?: {
