...
export function applyMessageDefaults(cfg: EnclawedConfig): EnclawedConfig {
...
export function applyTalkConfigNormalization(config: EnclawedConfig): EnclawedConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: EnclawedConfig): EnclawedConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: EnclawedConfig): EnclawedConfig {
...
export function applyLoggingDefaults(cfg: EnclawedConfig): EnclawedConfig {
...
export function applyContextPruningDefaults(cfg: EnclawedConfig): EnclawedConfig {
...
export function applyCompactionDefaults(cfg: EnclawedConfig): EnclawedConfig {
