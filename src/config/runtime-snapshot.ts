...
let runtimeConfigSnapshot: EnclawedConfig | null = null;
let runtimeConfigSourceSnapshot: EnclawedConfig | null = null;
...
function configSnapshotsMatch(left: EnclawedConfig, right: EnclawedConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: EnclawedConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): EnclawedConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: EnclawedConfig): string {
...
export function loadPinnedRuntimeConfig(loadFresh: () => EnclawedConfig): EnclawedConfig {
