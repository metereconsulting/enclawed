...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.ENCLAWED_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.ENCLAWED_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.ENCLAWED_WATCH_COMMAND),
