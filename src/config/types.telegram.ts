...
export type TelegramAccountConfig = {
  ...
  /**
   * Long-polling stall watchdog threshold in ms. When the polling transport
   * sees no successful update fetch within this window, Enclawed treats the
   * poll loop as stalled and restarts it.
   */
