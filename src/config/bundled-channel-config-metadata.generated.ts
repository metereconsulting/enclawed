...
export const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = [
  ...
  },
  {
    ...
    label: "QA Channel",
    description: "Synthetic Slack-class transport for automated Enclawed QA scenarios.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
  ...
  },
  {
    ...
    label: "Synology Chat",
    description: "Connect your Synology NAS Chat to Enclawed with full agent capabilities.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
  ...
  },
  {
    ...
    uiHints: {
      ...
      "execApprovals.approvers": {
        ...
        help: "Telegram user IDs allowed to approve exec requests for this bot account. Use numeric Telegram user IDs. If you leave this unset, Enclawed falls back to numeric owner IDs inferred from channels.telegram.allowFrom and direct-message defaultTo when possible.",
      },
      "execApprovals.agentFilter": {
