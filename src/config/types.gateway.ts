...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "enclawed.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.enclawed/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/enclawed"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__enclawed__/canvas or /__enclawed__/a2ui content.
   */
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/enclawed/enclawed/issues/47711
   */
