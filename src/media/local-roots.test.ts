...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "enclawed-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "enclawed-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "enclawed-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "enclawed-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "enclawed-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "enclawed-legacy-state");
    const configDir = path.join("/tmp", "enclawed-current-config");
