...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as ENCLAWED_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                HOME: homeDir,
                ENCLAWED_HOME: homeDir,
                ENCLAWED_CONFIG_PATH: configPath,
                ENCLAWED_STATE_DIR: stateDir,
                ENCLAWED_OAUTH_DIR: path.join(stateDir, "credentials"),
                ENCLAWED_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
