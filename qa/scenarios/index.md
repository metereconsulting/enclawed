...
- use `pnpm enclawed qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Enclawed QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Enclawed repo from source + docs before acting.
