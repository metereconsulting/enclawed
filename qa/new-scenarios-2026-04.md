...
- Code: `.agents/skills/enclawed-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/enclawed-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
