...
const WORKER_RUNTIME_STATE = Symbol.for("enclawed.testSetupRuntimeState");
const WORKER_RUNTIME_HELPERS = Symbol.for("enclawed.testSetupRuntimeHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: EnclawedConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
