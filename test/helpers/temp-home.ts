...
function snapshotEnv(): EnvSnapshot {
  return {
    ...
    openclawHome: process.env.ENCLAWED_HOME,
...
function restoreEnv(snapshot: EnvSnapshot) {
  ...
  restoreKey("ENCLAWED_HOME", snapshot.openclawHome);
...
function setTempHome(base: string) {
  ...
  // Ensure tests using HOME isolation aren't affected by leaked ENCLAWED_HOME.
  delete process.env.ENCLAWED_HOME;
  process.env.ENCLAWED_STATE_DIR = path.join(base, ".openclaw");
