...
function resolveSignalMaxBytes(cfg: EnclawedConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: EnclawedConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
