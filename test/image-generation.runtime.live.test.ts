...
const providerFilter = parseCsvFilter(process.env.ENCLAWED_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.ENCLAWED_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.ENCLAWED_LIVE_IMAGE_GENERATION_MODELS);
