...
Enclawed also runs a separate idempotent cleanup for older legacy sessions that
...
Enclawed auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Enclawed does not override them.
