---
summary: "Use SOUL.md to give your Enclawed agent an actual voice instead of generic assistant sludge"
read_when:
...
Enclawed injects it on normal sessions, so it has real weight. If your agent
...
For Enclawed, `SOUL.md` is that layer.
...
Path fixed for Enclawed workspaces: use `SOUL.md`, not `http://SOUL.md`.
