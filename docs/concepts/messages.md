...
This page ties together how Enclawed handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Enclawed keeps a
...
Enclawed separates the **prompt body** from the **command body**:
...
Enclawed can expose or hide model reasoning:
