---
summary: "Overview of Enclawed onboarding options and flows"
read_when:
...
Enclawed has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `enclawed onboard`                     | Launch the app            |
...
CLI command docs: [`enclawed onboard`](/cli/onboard)

## macOS app onboarding

Open the Enclawed app. The first-run wizard walks you through the same steps
