---
summary: "First-run setup flow for Enclawed (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Enclawed">
...
<Step title="CLI">
  ...
  The app can install the global `enclawed` CLI via npm, pnpm, or bun.
