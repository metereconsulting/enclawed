---
summary: "Use NVIDIA's OpenAI-compatible API in Enclawed"
read_when:
  - You want to use open models in Enclawed for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    enclawed onboard --auth-choice skip
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    enclawed models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
