...
read_when:
  - You want to use Together AI with Enclawed
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    enclawed onboard --auth-choice together-api-key
    ```
  </Step>
...
Enclawed ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `enclawed models list --provider together`
