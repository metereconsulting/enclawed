---
title: "fal"
summary: "fal image and video generation setup in Enclawed"
read_when:
  - You want to use fal image generation in Enclawed
...
Enclawed ships a bundled `fal` provider for hosted image and video generation.
...
<Steps>
  <Step title="Set the API key">
    ```bash
    enclawed onboard --auth-choice fal-api-key
    ```
  </Step>
...
<Tip>
Use `enclawed models list --provider fal` to see the full list of available fal
