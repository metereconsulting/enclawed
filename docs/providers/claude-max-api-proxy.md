...
<Steps>
  ...
  <Step title="Configure Enclawed">
    Point Enclawed at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Enclawed
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Enclawed integration with Claude CLI or API keys.
  </Card>
