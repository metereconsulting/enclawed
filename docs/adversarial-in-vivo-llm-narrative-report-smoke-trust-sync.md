...
Generated: 2026-05-03T01:51:29.081Z.
Samples per (channel, F-category, label): 5
Persistent audit log: `/tmp/smoke-trust/audit.jsonl`
Persistent witness journal: `/tmp/smoke-trust/witness.jsonl`
Per-sample CSV: `/home/metere1/enclawed-oss/docs/adversarial-in-vivo-samples-smoke-trust-sync.csv.gz`
...
| Run started at | 2026-05-03T01:51:28.540Z |
...
| F-category | TP | FP | TN | FN | precision (95% Wilson CI) | recall (95% Wilson CI) | FPR (95% Wilson CI) | F1 | accuracy |
|---|---|---|---|---|---|---|---|---|---|
| F1_BYPASS | 5 | 5 | 0 | 0 | 0.500 [0.237, 0.763] | 1.000 [0.566, 1.000] | 1.0000 [0, 1.0000] | 0.667 | 0.500 |
| F2_FORGE | 5 | 5 | 0 | 0 | 0.500 [0.237, 0.763] | 1.000 [0.566, 1.000] | 1.0000 [0, 1.0000] | 0.667 | 0.500 |
| F3_SILENT | 5 | 5 | 0 | 0 | 0.500 [0.237, 0.763] | 1.000 [0.566, 1.000] | 1.0000 [0, 1.0000] | 0.667 | 0.500 |
| F4_WRONGTGT | 5 | 5 | 0 | 0 | 0.500 [0.237, 0.763] | 1.000 [0.566, 1.000] | 1.0000 [0, 1.0000] | 0.667 | 0.500 |
...
|---|---|---|---|---|---|
| Enclawed vs enclawed-oss | 0 | 20 | 18.05 | 1 | < 0.001 |
| Enclawed vs enclawed-enclaved (content) | 0 | 40 | 38.02 | 1 | < 0.001 |
| Enclawed vs enclawed-enclaved (full) | 0 | 40 | 38.02 | 1 | < 0.001 |
| enclawed-oss vs enclawed-enclaved (content) | 0 | 20 | 18.05 | 1 | < 0.001 |
| enclawed-oss vs enclawed-enclaved (full) | 0 | 20 | 18.05 | 1 | < 0.001 |
...
- `accreditor not engaged at boot -- enclaved refuses all admissions`: 40
