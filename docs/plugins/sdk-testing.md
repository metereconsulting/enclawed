...
summary: "Testing utilities and patterns for Enclawed plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Enclawed
plugins.
...
**Import:** `@enclawed/plugin-sdk/testing`
...
} from "@enclawed/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "@enclawed/plugin-sdk/testing";
...
1. **No monolithic root imports** -- `@enclawed/plugin-sdk` root barrel is rejected
...
Enclawed uses Vitest with V8 coverage thresholds. For plugin tests:
