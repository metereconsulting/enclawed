...
If the active memory plugin exposes shared recall artifacts, Enclawed can search
...
currently exposing public bridge inputs yet. Run `enclawed wiki doctor` first,
...
enclawed wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
