...
Enclawed treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.enclawed/settings/voicewake.json`

Shape:

```json
{ "triggers": ["enclawed", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
