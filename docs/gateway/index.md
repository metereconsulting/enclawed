...
```bash
ENCLAWED_CONFIG_PATH=~/.openclaw/a.json ENCLAWED_STATE_DIR=~/.openclaw-a openclaw gateway --port 19001
ENCLAWED_CONFIG_PATH=~/.openclaw/b.json ENCLAWED_STATE_DIR=~/.openclaw-b openclaw gateway --port 19002
```
