---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic Enclawed QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Enclawed QA.
...
- Enclawed-native orchestration later
