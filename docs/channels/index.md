---
summary: "Messaging platforms Enclawed can connect to"
read_when:
  - You want to choose a chat channel for Enclawed
...
Enclawed can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [WeChat](https://www.npmjs.com/package/@tencent-weixin/enclawed-weixin) — Tencent iLink Bot plugin via QR login; private chats only.
...
- Channels can run simultaneously; configure multiple and Enclawed will route per chat.
