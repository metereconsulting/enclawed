...
Generated: 2026-05-03T02:30:31.897Z.
Samples per (channel, F-category, label): 100
Persistent audit log: `/home/metere1/.enclawed-invivo-crossllm/ol-mistral-7b/audit.jsonl`
Persistent witness journal: `/home/metere1/.enclawed-invivo-crossllm/ol-mistral-7b/witness.jsonl`
Per-sample CSV: `/home/metere1/enclawed-oss/docs/adversarial-in-vivo-samples-ol-mistral-7b.csv.gz`
...
| Run started at | 2026-05-03T02:27:14.546Z |
...
| F2_FORGE | 100 | 2 | 98 | 0 | 0.980 [0.931, 0.995] | 1.000 [0.963, 1.000] | 0.0200 [0, 0.0700] | 0.990 | 0.990 |
| F3_SILENT | 60 | 0 | 100 | 40 | 1.000 [0.940, 1.000] | 0.600 [0.502, 0.691] | 0.0000 [0, 0.0370] | 0.750 | 0.800 |
...
|---|---|---|---|---|---|
| OpenClaw vs enclawed-oss | 0 | 362 | 360.00 | 1 | < 0.001 |
| OpenClaw vs enclawed-enclaved (content) | 0 | 362 | 360.00 | 1 | < 0.001 |
| OpenClaw vs enclawed-enclaved (full) | 0 | 362 | 360.00 | 1 | < 0.001 |
...
- `content: DLP findings (severity=high)`: 60
- `content: DLP findings (severity=low)`: 2
