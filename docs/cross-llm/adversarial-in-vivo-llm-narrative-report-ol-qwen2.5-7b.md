...
Generated: 2026-05-03T02:32:40.995Z.
Samples per (channel, F-category, label): 100
Persistent audit log: `/home/metere1/.enclawed-invivo-crossllm/ol-qwen2.5-7b/audit.jsonl`
Persistent witness journal: `/home/metere1/.enclawed-invivo-crossllm/ol-qwen2.5-7b/witness.jsonl`
Per-sample CSV: `/home/metere1/enclawed-oss/docs/adversarial-in-vivo-samples-ol-qwen2.5-7b.csv.gz`
...
| Run started at | 2026-05-03T02:30:31.933Z |
...
| F3_SILENT | 84 | 0 | 100 | 16 | 1.000 [0.956, 1.000] | 0.840 [0.756, 0.899] | 0.0000 [0, 0.0370] | 0.913 | 0.920 |
| F4_WRONGTGT | 99 | 0 | 100 | 1 | 1.000 [0.963, 1.000] | 0.990 [0.946, 0.998] | 0.0000 [0, 0.0370] | 0.995 | 0.995 |
...
|---|---|---|---|---|---|---|---|---|---|
| F1_BYPASS | 100 | 0 | 100 | 0 | 1.000 [0.963, 1.000] | 1.000 [0.963, 1.000] | 0.0000 [0, 0.0370] | 1.000 | 1.000 |
| F2_FORGE | 100 | 5 | 95 | 0 | 0.952 [0.893, 0.979] | 1.000 [0.963, 1.000] | 0.0500 [0, 0.1118] | 0.976 | 0.975 |
| F3_SILENT | 84 | 0 | 100 | 16 | 1.000 [0.956, 1.000] | 0.840 [0.756, 0.899] | 0.0000 [0, 0.0370] | 0.913 | 0.920 |
| F4_WRONGTGT | 99 | 0 | 100 | 1 | 1.000 [0.963, 1.000] | 0.990 [0.946, 0.998] | 0.0000 [0, 0.0370] | 0.995 | 0.995 |
...
|---|---|---|---|---|---|
| OpenClaw vs enclawed-oss | 0 | 383 | 381.00 | 1 | < 0.001 |
| OpenClaw vs enclawed-enclaved (content) | 0 | 383 | 381.00 | 1 | < 0.001 |
| OpenClaw vs enclawed-enclaved (full) | 0 | 388 | 386.00 | 1 | < 0.001 |
| enclawed-oss vs enclawed-enclaved (content) | 0 | 0 | 0.00 | 1 | n.s. |
| enclawed-oss vs enclawed-enclaved (full) | 0 | 5 | 3.20 | 1 | n.s. |
...
- `content: DLP findings (severity=high)`: 84
...
- `content: DLP findings (severity=medium)`: 99
- `content: DLP findings (severity=high)`: 84
- `secmon: policy P-005 (unauthorized-access, severity=medium)`: 5

Total wall-clock: 129.0 s.
