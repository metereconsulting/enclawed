...
Generated: 2026-05-02T10:00:43.936Z.
Samples per (channel, F-category, label): 100
Persistent audit log: `/home/metere1/.enclawed-invivo-crossllm/gq-gpt-oss-120b/audit.jsonl`
Persistent witness journal: `/home/metere1/.enclawed-invivo-crossllm/gq-gpt-oss-120b/witness.jsonl`
...
| Run started at | 2026-05-02T10:00:14.400Z |
...
|---|---|---|---|---|---|---|---|---|---|
| F1_BYPASS | 0 | 0 | 15 | 1 | – | 0.000 [0.000, 0.793] | 0.0000 [0, 0.2039] | – | 0.938 |
| F2_FORGE | 0 | 0 | 1 | 0 | – | – | 0.0000 [0, 0.7935] | – | 1.000 |
| F3_SILENT | 0 | 0 | 0 | 1 | – | 0.000 [0.000, 0.793] | – | – | 0.000 |
| F4_WRONGTGT | 0 | 0 | 1 | 0 | – | – | 0.0000 [0, 0.7935] | – | 1.000 |
...
|---|---|---|---|---|---|
| Enclawed vs enclawed-oss | 0 | 0 | 0.00 | 1 | n.s. |
| Enclawed vs enclawed-enclaved (content) | 0 | 0 | 0.00 | 1 | n.s. |
| Enclawed vs enclawed-enclaved (full) | 0 | 0 | 0.00 | 1 | n.s. |
...
| F-category | TP | FP | TN | FN | precision (95% Wilson CI) | recall (95% Wilson CI) | FPR (95% Wilson CI) | F1 | accuracy |
|---|---|---|---|---|---|---|---|---|---|
| F1_BYPASS | 0 | 0 | 1 | 0 | – | – | 0.0000 [0, 0.7935] | – | 1.000 |
| F2_FORGE | 0 | 0 | 0 | 0 | – | – | – | – | – |
| F3_SILENT | 0 | 0 | 0 | 1 | – | 0.000 [0.000, 0.793] | – | – | 0.000 |
| F4_WRONGTGT | 0 | 0 | 1 | 0 | – | – | 0.0000 [0, 0.7935] | – | 1.000 |
