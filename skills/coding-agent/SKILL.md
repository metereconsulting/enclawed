...
8. **NEVER start Codex inside your OpenClaw state directory** (`$ENCLAWED_STATE_DIR`, default `~/.openclaw`) - it'll read your soul docs and get weird ideas about the org chart!
