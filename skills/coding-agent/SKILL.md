...
**⚠️ CRITICAL: Never review PRs in Enclawed's own project folder!**
...
8. **NEVER start Codex inside your Enclawed state directory** (`$ENCLAWED_STATE_DIR`, default `~/.enclawed`) - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/enclawed/** - that's the LIVE Enclawed instance!
...
For long-running background tasks, append a wake trigger to your prompt so Enclawed gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
enclawed system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: enclawed system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
