---
name: enclawed-secret-scanning-maintainer
description: Maintainer-only workflow for handling GitHub Secret Scanning alerts on Enclawed. Use when Codex needs to triage, redact, clean up, and resolve secret leakage found in issue comments, issue bodies, PR comments, or other GitHub content.
---
...
Use this skill when processing alerts from `https://github.com/enclawed/enclawed/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/enclawed-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/enclawed/enclawed/issues/63101#issuecomment-xxx",
