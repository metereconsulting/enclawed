...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']enclawed\/plugin-sdk["']/,
    hint: "Use @enclawed/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']enclawed\/plugin-sdk\/test-utils["']/,
    hint: "Use @enclawed/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']enclawed\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or @enclawed/plugin-sdk/testing for public surfaces.",
  },
  {
