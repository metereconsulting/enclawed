...
const DEFAULT_ENTRY = "enclawed.mjs";
...
function printUsage(): void {
  console.log(`Enclawed CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: enclawed.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "enclawed-cli-bench-"));
