...
const env = {
  ...process.env,
  ENCLAWED_LIVE_TEST: process.env.ENCLAWED_LIVE_TEST || "1",
  ENCLAWED_LIVE_TEST_QUIET: quietOverride ?? process.env.ENCLAWED_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.ENCLAWED_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
