...
ENCLAWED_APP_BUNDLE_ID = ai.openclaw.client
ENCLAWED_SHARE_BUNDLE_ID = ai.openclaw.client.share
ENCLAWED_ACTIVITY_WIDGET_BUNDLE_ID = ai.openclaw.client.activitywidget
ENCLAWED_WATCH_APP_BUNDLE_ID = ai.openclaw.client.watchkitapp
ENCLAWED_WATCH_EXTENSION_BUNDLE_ID = ai.openclaw.client.watchkitapp.extension
