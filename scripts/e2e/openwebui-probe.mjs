...
const targetModel =
  modelIds.find((id) => id === "enclawed/default") ?? modelIds.find((id) => id === "enclawed");
if (!targetModel) {
  throw new Error(`enclawed model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
