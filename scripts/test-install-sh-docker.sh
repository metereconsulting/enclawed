...
SMOKE_IMAGE="${ENCLAWED_INSTALL_SMOKE_IMAGE:-openclaw-install-smoke:local}"
NONROOT_IMAGE="${ENCLAWED_INSTALL_NONROOT_IMAGE:-openclaw-install-nonroot:local}"
...
CLI_INSTALL_URL="${ENCLAWED_INSTALL_CLI_URL:-https://openclaw.bot/install-cli.sh}"
PACKAGE_NAME="${ENCLAWED_INSTALL_PACKAGE:-openclaw}"
