...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("ENCLAWED_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("ENCLAWED_TEST_PERF_BASELINE_WALL_MS"),
      maxRegressionPct: readEnvNumber("ENCLAWED_TEST_PERF_MAX_REGRESSION_PCT") ?? 10,
    },
    [
