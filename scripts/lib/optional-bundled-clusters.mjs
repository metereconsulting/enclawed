...
export const OPTIONAL_BUNDLED_BUILD_ENV = "ENCLAWED_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.enclawed?.install?.npmSpec === "string" &&
    packageJson.enclawed.install.npmSpec.trim().length > 0
  );
}
