...
export function createPackageManagerWarningMessage(packageManager) {
  ...
  return [
    `[enclawed] warning: detected ${packageManager} for install lifecycle.`,
    "[enclawed] this repo works best with pnpm; npm-compatible installs are slower and much larger here.",
    "[enclawed] prefer: corepack pnpm install",
  ].join("\n");
}
