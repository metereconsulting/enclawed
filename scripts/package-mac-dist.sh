...
# Output:
# - dist/Enclawed.app
# - dist/Enclawed-<version>.zip
# - dist/Enclawed-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.enclawed.mac}"
...
APP="$ROOT_DIR/dist/Enclawed.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Enclawed-$VERSION.zip"
DMG="$ROOT_DIR/dist/Enclawed-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Enclawed-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Enclawed-$VERSION.dSYM.zip"
