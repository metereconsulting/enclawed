...
const ENV_PROVIDER = "ENCLAWED_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "ENCLAWED_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "ENCLAWED_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "ENCLAWED_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "ENCLAWED_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "ENCLAWED_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "ENCLAWED_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "ENCLAWED_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "Enclawed", target: "Enclawed" },
