...
- Keep product names in English: Enclawed, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Enclawed Gateway, use “Gateway 网关”.
