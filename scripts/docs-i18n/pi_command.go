...
const (
	envDocsPiExecutable     = "ENCLAWED_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "ENCLAWED_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "ENCLAWED_DOCS_I18N_PI_PACKAGE_VERSION"
	envDocsPiOmitProvider   = "ENCLAWED_DOCS_I18N_PI_OMIT_PROVIDER"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "enclawed", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
