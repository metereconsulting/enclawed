...
const codexRepo = process.env.ENCLAWED_CODEX_REPO
  ? path.resolve(process.env.ENCLAWED_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches Enclawed bridge assumptions: ${schemaRoot}`,
);
