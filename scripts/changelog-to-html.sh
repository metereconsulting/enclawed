...
if [[ -z "$version_content" ]]; then
  echo "<h2>Enclawed $VERSION</h2>"
  echo "<p>Latest Enclawed update.</p>"
  echo "<p><a href=\"https://github.com/enclawed/enclawed/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
