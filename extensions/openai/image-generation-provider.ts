...
} from "@enclawed/plugin-sdk/image-generation";
import {
  parseOpenAiCompatibleImageResponse,
  toImageDataUrl,
} from "@enclawed/plugin-sdk/image-generation";
import { createSubsystemLogger } from "@enclawed/plugin-sdk/logging-core";
import { resolveClosestSize } from "@enclawed/plugin-sdk/media-generation-runtime";
import {
...
import { resolveApiKeyForProvider } from "@enclawed/plugin-sdk/provider-auth-runtime";
import {
...
} from "@enclawed/plugin-sdk/provider-http";
import { isPrivateNetworkOptInEnabled } from "@enclawed/plugin-sdk/ssrf-runtime";
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.ENCLAWED_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: EnclawedConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: EnclawedConfig | undefined): boolean {
