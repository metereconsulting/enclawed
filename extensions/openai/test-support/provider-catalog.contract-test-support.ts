...
import type { ProviderPlugin } from "@enclawed/plugin-sdk/provider-test-contracts";
...
vi.mock("@enclawed/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("@enclawed/plugin-sdk/provider-catalog-runtime")
  >("@enclawed/plugin-sdk/provider-catalog-runtime");
