...
import type { ProviderAuthContext, ProviderAuthResult } from "@enclawed/plugin-sdk/plugin-entry";
import type { ProviderAuthMethod } from "@enclawed/plugin-sdk/plugin-entry";
