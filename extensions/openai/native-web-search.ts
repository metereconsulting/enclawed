...
import { streamWithPayloadPatch } from "@enclawed/plugin-sdk/provider-stream-shared";
...
function shouldUseOpenAINativeWebSearchProvider(config: EnclawedConfig | undefined): boolean {
