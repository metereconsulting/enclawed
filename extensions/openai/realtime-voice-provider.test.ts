import { REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ } from "@enclawed/plugin-sdk/realtime-voice";
...
describe("buildOpenAIRealtimeVoiceProvider", () => {
  ...
  it("adds Enclawed attribution headers to native realtime websocket requests", () => {
  ...
  it("returns browser-safe Enclawed attribution headers for native WebRTC offers", async () => {
    vi.stubEnv("ENCLAWED_VERSION", "2026.3.22");
