import type { MemoryEmbeddingProviderCreateOptions } from "@enclawed/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("@enclawed/plugin-sdk/memory-core-host-engine-embeddings", () => ({
