...
type AgentDefaultsModel = NonNullable<NonNullable<EnclawedConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<EnclawedConfig["agents"]>["defaults"]>["models"];
type AgentDefaultsRuntimePolicy = NonNullable<
  NonNullable<EnclawedConfig["agents"]>["defaults"]
>["agentRuntime"];
