...
} from "@enclawed/plugin-sdk/cli-backend";
...
// steer Enclawed-managed Claude CLI runs toward a different provider,
...
function isEnclawedRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isEnclawedRequestedYolo(context)
