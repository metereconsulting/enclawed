...
import type { HarnessContextEngine as ContextEngine } from "@enclawed/plugin-sdk/agent-harness-runtime";
...
describe("maybeCompactCodexAppServerSession", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "enclawed-codex-compact-"));
  });
