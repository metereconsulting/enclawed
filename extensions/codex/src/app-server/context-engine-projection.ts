import type { AgentMessage } from "@enclawed/plugin-sdk/agent-harness-runtime";
...
const CONTEXT_HEADER = "Enclawed assembled context for this turn:";
...
/**
 * Project assembled Enclawed context-engine messages into Codex prompt inputs.
 */
