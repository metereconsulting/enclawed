...
import { resolveLivePluginConfigObject } from "@enclawed/plugin-sdk/plugin-config-runtime";
...
export default definePluginEntry({
  ...
  register(api) {
    const resolveCurrentPluginConfig = () => {
      const currentFn = api.runtime.config?.current;
      return (
        resolveLivePluginConfigObject(
          currentFn ? () => currentFn() as EnclawedConfig : undefined,
          "codex",
