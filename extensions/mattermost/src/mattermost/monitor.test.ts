import { createClaimableDedupe } from "@enclawed/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: EnclawedConfig; threadRootId?: string }) {
