import { createAccountListHelpers } from "@enclawed/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "@enclawed/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "@enclawed/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: EnclawedConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: EnclawedConfig): string {
