...
import type { ChannelSetupAdapter } from "@enclawed/plugin-sdk/channel-setup";
...
import { createSetupInputPresenceValidator } from "@enclawed/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: EnclawedConfig, accountId: string) {
