import type { ChannelDoctorLegacyConfigRule } from "@enclawed/plugin-sdk/channel-contract";
import type { EnclawedConfig } from "@enclawed/plugin-sdk/config-types";
import { isRecord } from "@enclawed/plugin-sdk/text-runtime";
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: EnclawedConfig }): {
