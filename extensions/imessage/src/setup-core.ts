...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: EnclawedConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: EnclawedConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: EnclawedConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Enclawed has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: EnclawedConfig; accountId?: string }) =>
