...
import { createChannelPairingChallengeIssuer } from "@enclawed/plugin-sdk/channel-pairing";
...
import { recordInboundSession } from "@enclawed/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "@enclawed/plugin-sdk/host-runtime";
import { runInboundReplyTurn } from "@enclawed/plugin-sdk/inbound-reply-dispatch";
import { isInboundPathAllowed, kindFromMime } from "@enclawed/plugin-sdk/media-runtime";
import { DEFAULT_GROUP_HISTORY_LIMIT, type HistoryEntry } from "@enclawed/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "@enclawed/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "@enclawed/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "@enclawed/plugin-sdk/reply-runtime";
import { settleReplyDispatcher } from "@enclawed/plugin-sdk/reply-runtime";
import { getRuntimeConfig } from "@enclawed/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose, shouldLogVerbose, warn } from "@enclawed/plugin-sdk/runtime-env";
import {
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "@enclawed/plugin-sdk/runtime-group-policy";
import { resolvePinnedMainDmOwnerFromAllowlist } from "@enclawed/plugin-sdk/security-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "@enclawed/plugin-sdk/session-store-runtime";
import { truncateUtf16Safe } from "@enclawed/plugin-sdk/text-runtime";
import { waitForTransportReady } from "@enclawed/plugin-sdk/transport-ready-runtime";
 ...
 *   exec ssh -T enclawed@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., enclawed@192.168.64.3)
