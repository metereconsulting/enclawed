...
function mergeIMessageAccountConfig(cfg: EnclawedConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: EnclawedConfig): ResolvedIMessageAccount[] {
