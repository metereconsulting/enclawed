...
vi.mock("@enclawed/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/provider-http")>(
    "@enclawed/plugin-sdk/provider-http",
  );
  return {
    ...actual,
