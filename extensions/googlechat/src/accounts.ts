...
import { safeParseJsonWithSchema, safeParseWithSchema } from "@enclawed/plugin-sdk/extension-shared";
import { isSecretRef } from "@enclawed/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: EnclawedConfig): ResolvedGoogleChatAccount[] {
