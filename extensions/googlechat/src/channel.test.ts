...
function resolveGoogleChatAccountImpl(params: { cfg: EnclawedConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: EnclawedConfig) => {
...
function createGoogleChatCfg(): EnclawedConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
