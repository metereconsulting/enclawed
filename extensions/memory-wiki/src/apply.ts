...
const GENERATED_START = "<!-- enclawed:wiki:generated:start -->";
const GENERATED_END = "<!-- enclawed:wiki:generated:end -->";
const HUMAN_START = "<!-- enclawed:human:start -->";
const HUMAN_END = "<!-- enclawed:human:end -->";
