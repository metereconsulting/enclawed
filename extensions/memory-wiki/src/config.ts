...
import { buildPluginConfigSchema, z, type EnclawedPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: EnclawedPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".enclawed", "wiki", "main");
}
