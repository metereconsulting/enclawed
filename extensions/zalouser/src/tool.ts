import type { AnyAgentTool, EnclawedPluginToolContext } from "@enclawed/plugin-sdk/core";
...
type ZalouserToolContext = Pick<EnclawedPluginToolContext, "deliveryContext">;
