...
const FEISHU_USER_AGENT = `enclawed-feishu-builtin/${pluginVersion}/${process.platform}`;
...
export const FEISHU_HTTP_TIMEOUT_ENV_VAR = "ENCLAWED_FEISHU_HTTP_TIMEOUT_MS";
