...
} from "@enclawed/plugin-sdk/interactive-runtime";
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("@enclawed/plugin-sdk/setup-runtime");
          const { replaceConfigFile } = await import("@enclawed/plugin-sdk/config-mutation");
