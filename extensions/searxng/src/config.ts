...
export function resolveSearxngCategories(config?: EnclawedConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: EnclawedConfig): string | undefined {
