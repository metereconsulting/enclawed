...
function mergeZaloAccountConfig(cfg: EnclawedConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: EnclawedConfig): ResolvedZaloAccount[] {
