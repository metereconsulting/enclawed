...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under Enclawed control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredEnclawedTmpDir(), "enclawed-zalo-outbound-media");
