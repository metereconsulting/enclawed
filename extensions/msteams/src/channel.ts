import { describeAccountSnapshot } from "@enclawed/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "@enclawed/plugin-sdk/allow-from";
import { createTopLevelChannelConfigAdapter } from "@enclawed/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "@enclawed/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "@enclawed/plugin-sdk/channel-core";
...
} from "@enclawed/plugin-sdk/directory-runtime";
import { normalizeMessagePresentation } from "@enclawed/plugin-sdk/interactive-runtime";
import { createLazyRuntimeNamedExport } from "@enclawed/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "@enclawed/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "@enclawed/plugin-sdk/status-helpers";
import { normalizeOptionalString } from "@enclawed/plugin-sdk/text-runtime";
import { Type } from "typebox";
import type { ChannelMessageActionName, ChannelPlugin, EnclawedConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: EnclawedConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: EnclawedConfig }>(
