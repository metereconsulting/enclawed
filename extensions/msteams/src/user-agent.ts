...
function resolveEnclawedVersion(): string {
  try {
 ...
 * and appends the Enclawed version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Enclawed/<enclawed-version>"
 * Example: "teams.ts[apps]/2.0.5 Enclawed/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Enclawed/${resolveEnclawedVersion()}`;
  return cachedUserAgent;
}
