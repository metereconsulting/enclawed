...
import { collectProviderDangerousNameMatchingScopes } from "@enclawed/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: EnclawedConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: EnclawedConfig,
  doctorFixCommand: string,
): { config: EnclawedConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: EnclawedConfig): string[] {
