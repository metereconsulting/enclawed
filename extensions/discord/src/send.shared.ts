...
import { buildOutboundMediaLoadOptions } from "@enclawed/plugin-sdk/media-runtime";
import { extensionForMime } from "@enclawed/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "@enclawed/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "@enclawed/plugin-sdk/reply-payload";
import type { RetryRunner } from "@enclawed/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: EnclawedConfig },
): Promise<{ channelId: string; dm?: boolean }> {
