import { createLazyChannelApprovalNativeRuntimeAdapter } from "@enclawed/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelApprovalNativeRuntimeAdapter } from "@enclawed/plugin-sdk/approval-handler-runtime";
import { resolveApprovalRequestSessionConversation } from "@enclawed/plugin-sdk/approval-native-runtime";
import type { ChannelApprovalCapability } from "@enclawed/plugin-sdk/channel-contract";
import type { DiscordExecApprovalConfig } from "@enclawed/plugin-sdk/config-types";
import {
