...
import { danger, warn, type RuntimeEnv } from "@enclawed/plugin-sdk/runtime-env";
import { normalizeLowercaseStringOrEmpty } from "@enclawed/plugin-sdk/text-runtime";

export type GetPluginCommandSpecs =
  typeof import("@enclawed/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("@enclawed/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("@enclawed/plugin-sdk/plugin-runtime");
