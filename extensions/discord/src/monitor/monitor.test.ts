...
import { buildPluginBindingApprovalCustomId } from "@enclawed/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  const createCfg = (): EnclawedConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/enclawed-sessions-test.json");
