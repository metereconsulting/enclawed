...
import { danger } from "@enclawed/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("@enclawed/plugin-sdk/config-types").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class EnclawedGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new EnclawedGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Enclawed registers its own async interaction listener.
