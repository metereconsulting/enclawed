...
import type { DiscordAccountConfig } from "@enclawed/plugin-sdk/config-types";
import * as pluginCommandsModule from "@enclawed/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "@enclawed/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: EnclawedConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: EnclawedConfig) => void;
