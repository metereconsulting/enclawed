...
import type { EnclawedConfig, ReplyToMode } from "@enclawed/plugin-sdk/config-types";
import { createConnectedChannelStatusPatch } from "@enclawed/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "@enclawed/plugin-sdk/runtime-env";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("@enclawed/plugin-sdk/reply-history").HistoryEntry[]
    >();
