...
import type { SessionBindingRecord } from "@enclawed/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "@enclawed/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "@enclawed/plugin-sdk/routing";
...
type LoadedConfig = EnclawedConfig;
export type RuntimeEnv = import("@enclawed/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("@enclawed/plugin-sdk/config-types").EnclawedConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
