...
import { createNonExitingRuntime, logVerbose } from "@enclawed/plugin-sdk/runtime-env";
import { logError } from "@enclawed/plugin-sdk/text-runtime";
...
let replyPipelineRuntimePromise:
  | Promise<typeof import("@enclawed/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("@enclawed/plugin-sdk/channel-reply-pipeline");
