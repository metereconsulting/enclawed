...
import { normalizeAccountId as normalizeSharedAccountId } from "@enclawed/plugin-sdk/account-id";
...
import { normalizeProviderId } from "@enclawed/plugin-sdk/provider-model-shared";
