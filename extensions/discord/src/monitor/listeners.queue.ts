import { createSubsystemLogger, formatDurationSeconds } from "@enclawed/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("@enclawed/plugin-sdk/runtime-env").createSubsystemLogger
>;
