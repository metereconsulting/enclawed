...
vi.mock("@enclawed/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/routing")>(
...
vi.mock("@enclawed/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/agent-runtime")>(
