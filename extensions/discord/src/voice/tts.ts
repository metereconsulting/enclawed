...
import type { EnclawedConfig, TtsConfig } from "@enclawed/plugin-sdk/config-types";
import { parseTtsDirectives } from "@enclawed/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: EnclawedConfig; override?: TtsConfig }): {
  cfg: EnclawedConfig;
