...
import { listCombinedAccountIds } from "@enclawed/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: EnclawedConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: EnclawedConfig): string {
