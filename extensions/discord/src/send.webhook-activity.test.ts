...
vi.mock("@enclawed/plugin-sdk/channel-activity-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("@enclawed/plugin-sdk/channel-activity-runtime")
  >("@enclawed/plugin-sdk/channel-activity-runtime");
  return {
    ...actual,
