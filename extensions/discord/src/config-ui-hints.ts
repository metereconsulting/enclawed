...
export const discordChannelConfigUiHints = {
  ...
  "eventQueue.listenerTimeout": {
    ...
    help: "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Default is 120000 in Enclawed; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
  },
  ...
  gatewayInfoTimeoutMs: {
    ...
    help: "Timeout for Discord /gateway/bot metadata lookup before falling back to the default gateway URL. Default is 30000; ENCLAWED_DISCORD_GATEWAY_INFO_TIMEOUT_MS can override when config is unset.",
  },
  "voice.enabled": {
  ...
  "voice.reconnectGraceMs": {
    ...
    help: "Grace period for a disconnected Discord voice session to enter Signalling or Connecting before Enclawed destroys it. Default: 15000.",
  },
  "voice.tts": {
