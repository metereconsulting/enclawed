...
// Deprecated compatibility surface for existing @enclawed/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "@enclawed/plugin-sdk/runtime-group-policy";
