...
vi.mock("@enclawed/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/media-understanding")>(
    "@enclawed/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
