...
import { buildOauthProviderAuthResult } from "@enclawed/plugin-sdk/provider-auth-result";
...
import { fetchGeminiUsage } from "@enclawed/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: EnclawedPluginApi) {
