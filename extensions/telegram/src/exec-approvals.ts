import { resolveApprovalApprovers } from "@enclawed/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "@enclawed/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "@enclawed/plugin-sdk/approval-runtime";
import type { EnclawedConfig } from "@enclawed/plugin-sdk/config-types";
import type { TelegramExecApprovalConfig } from "@enclawed/plugin-sdk/config-types";
...
function resolveTelegramOwnerApprovers(cfg: EnclawedConfig): Array<string | number> {
