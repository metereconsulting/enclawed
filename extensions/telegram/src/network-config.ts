...
import { isTruthyEnvValue, isWSL2Sync } from "@enclawed/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "@enclawed/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "ENCLAWED_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ENCLAWED_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "ENCLAWED_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable ENCLAWED_TELEGRAM_DNS_RESULT_ORDER
