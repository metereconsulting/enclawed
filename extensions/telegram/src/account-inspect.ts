import { resolveAccountWithDefaultFallback } from "@enclawed/plugin-sdk/account-core";
...
import { coerceSecretRef } from "@enclawed/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: EnclawedConfig; value: unknown }): {
  token: string;
