import { normalizeAccountId } from "@enclawed/plugin-sdk/account-core";
import { mapAllowFromEntries } from "@enclawed/plugin-sdk/channel-config-helpers";
import type { EnclawedConfig, TelegramAccountConfig } from "@enclawed/plugin-sdk/config-types";
import { createResolvedDirectoryEntriesLister } from "@enclawed/plugin-sdk/directory-config-runtime";
