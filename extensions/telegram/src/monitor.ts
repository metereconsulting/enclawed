...
import { resolveAgentMaxConcurrent } from "@enclawed/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: EnclawedConfig): RunOptions<unknown> {
  return {
    sink: {
