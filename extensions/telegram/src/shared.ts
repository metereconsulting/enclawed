import { resolveNormalizedAccountEntry } from "@enclawed/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "@enclawed/plugin-sdk/channel-core";
import { getChatChannelMeta } from "@enclawed/plugin-sdk/channel-plugin-common";
import type { EnclawedConfig, TelegramAccountConfig } from "@enclawed/plugin-sdk/config-types";
 ...
 *
 * See: https://github.com/enclawed/enclawed/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: EnclawedConfig, accountId: string): boolean {
