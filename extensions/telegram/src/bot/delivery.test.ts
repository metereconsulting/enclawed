...
vi.mock("@enclawed/plugin-sdk/media-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@enclawed/plugin-sdk/media-runtime")>();
  return {
    ...actual,
...
vi.mock("@enclawed/plugin-sdk/hook-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@enclawed/plugin-sdk/hook-runtime")>();
  return {
    ...actual,
    triggerInternalHook,
  };
...
vi.mock("@enclawed/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@enclawed/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
