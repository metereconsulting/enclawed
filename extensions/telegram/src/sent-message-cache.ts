...
const TELEGRAM_SENT_MESSAGES_STATE_KEY = Symbol.for("enclawed.telegramSentMessagesState");
...
function resolveSentMessageStorePath(cfg?: Pick<EnclawedConfig, "session">): string {
...
function getSentMessageBucket(cfg?: Pick<EnclawedConfig, "session">): SentMessageBucket {
...
function getSentMessages(cfg?: Pick<EnclawedConfig, "session">): SentMessageStore {
...
export function recordSentMessage(
  ...
  messageId: number,
  cfg?: Pick<EnclawedConfig, "session">,
): void {
