...
import {
  ...
  type EnclawedConfig,
} from "@enclawed/plugin-sdk/account-core";
import type { TelegramAccountConfig, TelegramActionConfig } from "@enclawed/plugin-sdk/config-types";
import { formatSetExplicitDefaultInstruction } from "@enclawed/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "@enclawed/plugin-sdk/runtime-env";
...
export function listTelegramAccountIds(cfg: EnclawedConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: EnclawedConfig): string {
...
export function listEnabledTelegramAccounts(cfg: EnclawedConfig): ResolvedTelegramAccount[] {
