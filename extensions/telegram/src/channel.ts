...
import type { ChannelMessageActionAdapter } from "@enclawed/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "@enclawed/plugin-sdk/channel-lifecycle";
...
} from "@enclawed/plugin-sdk/outbound-send-deps";
import { type RoutePeer } from "@enclawed/plugin-sdk/routing";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as EnclawedConfig;
