...
import { isAbortRequestText } from "@enclawed/plugin-sdk/command-primitives-runtime";
import type {
  EnclawedConfig,
  ReplyToMode,
...
async function resolveStickerVisionSupport(cfg: EnclawedConfig, agentId: string) {
  try {
