import type { BaseProbeResult, BaseTokenResolution } from "@enclawed/plugin-sdk/channel-contract";
import { expectDirectoryIds } from "@enclawed/plugin-sdk/channel-test-helpers";
