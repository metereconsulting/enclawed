...
import type { BaseTokenResolution } from "@enclawed/plugin-sdk/channel-contract";
import { tryReadSecretFileSync } from "@enclawed/plugin-sdk/channel-core";
import type { EnclawedConfig } from "@enclawed/plugin-sdk/config-types";
import type { TelegramAccountConfig } from "@enclawed/plugin-sdk/config-types";
import { resolveDefaultSecretProviderAlias } from "@enclawed/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "@enclawed/plugin-sdk/routing";
import {
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<EnclawedConfig, "secrets">;
  provider: string;
  id: string;
