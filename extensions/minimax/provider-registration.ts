...
import { createProviderApiKeyAuthMethod } from "@enclawed/plugin-sdk/provider-auth-api-key";
import { buildProviderReplayFamilyHooks } from "@enclawed/plugin-sdk/provider-model-shared";
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "@enclawed/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "@enclawed/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: EnclawedPluginApi) {
