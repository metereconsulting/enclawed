...
import { asFiniteNumber, asObject, trimToUndefined } from "@enclawed/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: EnclawedConfig | undefined): string | undefined {
