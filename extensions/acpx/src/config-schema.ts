import { buildPluginConfigSchema } from "@enclawed/plugin-sdk/core";
import { z } from "@enclawed/plugin-sdk/zod";
import type { EnclawedPluginConfigSchema } from "../runtime-api.js";
...
export function createAcpxPluginConfigSchema(): EnclawedPluginConfigSchema {
