...
import { SELF_HOSTED_DEFAULT_COST } from "@enclawed/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "@enclawed/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to Enclawed model definitions. */
