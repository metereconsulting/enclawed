...
vi.mock("@enclawed/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@enclawed/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
