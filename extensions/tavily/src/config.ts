...
export function resolveTavilySearchConfig(cfg?: EnclawedConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: EnclawedConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: EnclawedConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
