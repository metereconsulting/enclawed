...
import { buildApiKeyCredential } from "@enclawed/plugin-sdk/provider-auth";
import {
  ...
  register(api: EnclawedPluginApi) {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "enclawed configure". ' +
        "See: https://docs.enclawed.ai/providers/ollama",
    });
  },
});
