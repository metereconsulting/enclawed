...
import { resolveEnvApiKey } from "@enclawed/plugin-sdk/provider-auth-runtime";
import {
...
function resolveOllamaWebSearchApiKey(config?: EnclawedConfig): string | undefined {
...
function resolveOllamaWebSearchBaseUrl(config?: EnclawedConfig): string {
