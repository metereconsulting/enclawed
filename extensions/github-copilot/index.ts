...
function applyCopilotDefaultModel(cfg: EnclawedConfig): EnclawedConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: EnclawedConfig): GithubCopilotPluginConfig {
