...
import { buildApprovalInteractiveReplyFromActionDescriptors } from "@enclawed/plugin-sdk/approval-reply-runtime";
import type { ExecApprovalRequest } from "@enclawed/plugin-sdk/approval-runtime";
import type { EnclawedConfig } from "@enclawed/plugin-sdk/config-types";
import { logError, normalizeOptionalString } from "@enclawed/plugin-sdk/text-runtime";
import {
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<EnclawedConfig["channels"]>["slack"]>["execApprovals"]
>;
