...
} from "@enclawed/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "@enclawed/plugin-sdk/channel-config-helpers";
import {
...
import { createLazyRuntimeModule } from "@enclawed/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "@enclawed/plugin-sdk/outbound-send-deps";
import { buildOutboundBaseSessionKey, type RoutePeer } from "@enclawed/plugin-sdk/routing";
import {
...
//
// `@enclawed/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "@enclawed/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "@enclawed/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as EnclawedConfig, toolContext as SlackActionContext | undefined),
    }),
