...
vi.mock("@enclawed/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/fetch-runtime")>(
    "@enclawed/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
