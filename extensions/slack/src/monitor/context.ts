...
import { resolveDefaultAgentId } from "@enclawed/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "@enclawed/plugin-sdk/allow-from";
import type {
  EnclawedConfig,
  SlackReactionNotificationMode,
} from "@enclawed/plugin-sdk/config-types";
import type { SessionScope } from "@enclawed/plugin-sdk/config-types";
import type { DmPolicy, GroupPolicy } from "@enclawed/plugin-sdk/config-types";
import { createDedupeCache } from "@enclawed/plugin-sdk/dedupe-runtime";
import { formatErrorMessage } from "@enclawed/plugin-sdk/error-runtime";
import type { HistoryEntry } from "@enclawed/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("@enclawed/plugin-sdk/config-types").SlackSlashCommandConfig>;
  textLimit: number;
