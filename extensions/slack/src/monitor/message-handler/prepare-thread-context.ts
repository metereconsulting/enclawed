import { formatInboundEnvelope } from "@enclawed/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "@enclawed/plugin-sdk/config-types";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("@enclawed/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
