...
vi.mock("@enclawed/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("@enclawed/plugin-sdk/channel-streaming", () => ({
...
vi.mock("@enclawed/plugin-sdk/outbound-runtime", () => ({
  resolveAgentOutboundIdentity: () => undefined,
}));

vi.mock("@enclawed/plugin-sdk/reply-history", () => ({
  clearHistoryEntriesIfEnabled: () => {},
}));

vi.mock("@enclawed/plugin-sdk/reply-payload", () => ({
...
vi.mock("@enclawed/plugin-sdk/text-runtime", () => ({
...
vi.mock("../config.runtime.js", () => ({
  resolveStorePath: () => "/tmp/enclawed-store.json",
