...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<EnclawedConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<EnclawedConfig["channels"]>["slack"]>>,
): EnclawedConfig {
  return {
    channels: {
      slack: {
