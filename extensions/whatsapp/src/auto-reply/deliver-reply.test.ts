...
import { sleep } from "@enclawed/plugin-sdk/text-runtime";
...
vi.mock("@enclawed/plugin-sdk/text-runtime", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/text-runtime")>(
