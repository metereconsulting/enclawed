import type { AckReactionHandle } from "@enclawed/plugin-sdk/channel-feedback";
import type { getReplyFromConfig } from "@enclawed/plugin-sdk/reply-runtime";
import type { MsgContext } from "@enclawed/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "@enclawed/plugin-sdk/routing";
import { buildGroupHistoryKey } from "@enclawed/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("@enclawed/plugin-sdk/runtime-env"))["getChildLogger"]>;
