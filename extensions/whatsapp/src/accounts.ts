...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "@enclawed/plugin-sdk/config-types";
import { resolveOAuthDir } from "@enclawed/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: EnclawedConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: EnclawedConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: EnclawedConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: EnclawedConfig): ResolvedWhatsAppAccount[] {
