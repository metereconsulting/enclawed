...
const mocks = vi.hoisted(() => ({
  runtimeConfig: {} as EnclawedConfig,
  runtimeSourceConfig: null as EnclawedConfig | null,
...
vi.mock("../browser/chrome.js", () => ({
  ...
  launchEnclawedChrome: vi.fn(async () => {
    throw new Error("launch should not be needed for status");
  }),
  resolveEnclawedUserDataDir: vi.fn(() => "/tmp/enclawed-browser"),
