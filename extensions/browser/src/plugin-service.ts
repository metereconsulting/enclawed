...
export function createBrowserPluginService(): EnclawedPluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "ENCLAWED_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "ENCLAWED_BROWSER_CONTROL_MODULE",
