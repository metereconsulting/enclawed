...
import {
  ...
  sessionPathForFile,
} from "@enclawed/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "@enclawed/plugin-sdk/memory-core-host-runtime-files";
import {
...
const LIGHT_SLEEP_EVENT_TEXT = "__enclawed_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__enclawed_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- enclawed:dreaming:light:start -->",
    endMarker: "<!-- enclawed:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- enclawed:dreaming:rem:start -->",
    endMarker: "<!-- enclawed:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: EnclawedPluginApi): void {
