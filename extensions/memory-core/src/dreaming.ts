import { peekSystemEventEntries } from "@enclawed/plugin-sdk/infra-runtime";
import type { EnclawedConfig, EnclawedPluginApi } from "@enclawed/plugin-sdk/memory-core";
import {
...
const DREAMING_SYSTEM_EVENT_TEXT = "__enclawed_memory_core_short_term_promotion_dream__";
...
function resolveStartupConfigFromEvent(event: unknown, fallback: EnclawedConfig): EnclawedConfig {
  ...
  return startupCfg as EnclawedConfig;
}
...
export function registerShortTermPromotionDreaming(api: EnclawedPluginApi): void {
