...
import { resolveGlobalMap } from "@enclawed/plugin-sdk/global-singleton";
import { createAsyncLock } from "@enclawed/plugin-sdk/infra-runtime";
import { resolveStateDir } from "@enclawed/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- enclawed:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- enclawed:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "enclawed:dreaming:backfill-entry";
