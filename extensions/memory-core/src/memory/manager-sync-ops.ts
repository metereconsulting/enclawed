...
} from "@enclawed/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: EnclawedConfig;
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        ...
        process.env.ENCLAWED_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
