...
import { resolveUserPath } from "@enclawed/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "@enclawed/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Enclawed (this should install node-llama-cpp): npm i -g enclawed@latest"
      : null,
