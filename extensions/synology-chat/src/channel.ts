/**
 * Synology Chat Channel Plugin for Enclawed.
 *
...
import { attachChannelToResult } from "@enclawed/plugin-sdk/channel-send-result";
import { createEmptyChannelDirectoryAdapter } from "@enclawed/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "enclawed pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: EnclawedConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: EnclawedConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Enclawed",
        order: 90,
      },
      capabilities: {
