import { DEFAULT_ACCOUNT_ID, type EnclawedConfig } from "@enclawed/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "@enclawed/plugin-sdk/webhook-ingress";
