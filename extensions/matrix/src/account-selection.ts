...
import { hasConfiguredSecretInput } from "@enclawed/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: EnclawedConfig): Record<string, unknown> | null {
