import type { OutputRuntimeEnv } from "@enclawed/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "@enclawed/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Enclawed Gateway",
    },
    confirm: {
