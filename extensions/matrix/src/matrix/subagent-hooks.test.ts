import type { EnclawedPluginApi as MatrixEntryPluginApi } from "@enclawed/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("@enclawed/plugin-sdk/conversation-binding-runtime", () => ({
