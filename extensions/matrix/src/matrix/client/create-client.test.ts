...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/enclawed-matrix-create-client-test",
    storagePath: "/tmp/enclawed-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/enclawed-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/enclawed-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/enclawed-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "enclawed-matrix-default-token-hash",
