...
import { buildPluginApprovalResolvedReplyPayload } from "@enclawed/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// Enclawed Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.enclawed.approval" as const;
