...
${imageBlock}    pull_policy: never
    ...
    environment:
      ENCLAWED_CONFIG_PATH: /tmp/openclaw/openclaw.json
      ENCLAWED_STATE_DIR: /tmp/openclaw/state
...
1. Build the prebaked image once:
   - \`docker build -t openclaw:qa-local-prebaked --build-arg ENCLAWED_EXTENSIONS="qa-channel qa-lab" -f Dockerfile .\`
2. Start the stack:
