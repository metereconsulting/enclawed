...
function resolveLegacyXSearchConfig(config?: EnclawedConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: EnclawedConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: EnclawedConfig): JsonRecord | undefined {
