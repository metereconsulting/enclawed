...
import { buildPluginConfigSchema, type EnclawedPluginConfigSchema } from "@enclawed/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): EnclawedPluginConfigSchema {
