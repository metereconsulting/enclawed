...
function mergeSignalAccountConfig(cfg: EnclawedConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: EnclawedConfig): ResolvedSignalAccount[] {
