...
vi.mock("@enclawed/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("@enclawed/plugin-sdk/hook-runtime")>(
    "@enclawed/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
