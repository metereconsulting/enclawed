...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through Enclawed browser automation.",
    },
    ...
    "realtime.agentId": {
      ...
      help: 'Enclawed agent id used by enclawed_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {
