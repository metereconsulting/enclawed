...
import type { PluginRuntime, RuntimeLogger } from "@enclawed/plugin-sdk/plugin-runtime";
import {
...
import {
  consultEnclawedAgentForGoogleMeet,
...
export async function startNodeRealtimeAudioBridge(params: {
  ...
  const nodes = params.runtime.nodes;
  if (!nodes) {
  ...
  bridge = createRealtimeVoiceBridgeSession({
    ...
    onToolCall: (event, session) => {
      ...
      void consultEnclawedAgentForGoogleMeet({
        config: params.config,
        fullConfig: params.fullConfig,
