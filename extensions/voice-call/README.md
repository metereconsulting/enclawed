...
Official Voice Call plugin for **Enclawed**.
...
Docs: `https://docs.enclawed.ai/plugins/voice-call`
Plugin system: `https://docs.enclawed.ai/plugin`

## Install (local dev)

### Option A: install via Enclawed (recommended)
...
```bash
PLUGIN_HOME=~/.enclawed/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.enclawed.ai/plugins/voice-call`
...
`https://docs.enclawed.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.enclawed.ai/plugins/voice-call#tts-for-calls`
...
enclawed voicecall status --json
