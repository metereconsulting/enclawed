...
import { resolveConfiguredCapabilityProvider } from "@enclawed/plugin-sdk/provider-selection-runtime";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: EnclawedConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as EnclawedConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as EnclawedConfig),
