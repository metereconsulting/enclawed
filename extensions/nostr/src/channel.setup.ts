...
import { patchTopLevelChannelConfigSection } from "@enclawed/plugin-sdk/setup";
import {
...
function getNostrConfig(cfg: EnclawedConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: EnclawedConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: EnclawedConfig): string {
