...
Nostr DM channel plugin for Enclawed using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Enclawed. It enables your bot to:
...
# Configure enclawed to use local relay
