...
import { createStartAccountContext } from "@enclawed/plugin-sdk/channel-test-helpers";
import {
  createPluginSetupWizardConfigure,
  createTestWizardPrompter,
  runSetupWizardConfigure,
} from "@enclawed/plugin-sdk/plugin-test-runtime";
import type { WizardPrompter } from "@enclawed/plugin-sdk/plugin-test-runtime";
import { bundledPluginRoot } from "@enclawed/plugin-sdk/test-fixtures";
import ts from "typescript";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import type { EnclawedConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function collectRuntimeApiPreExports(runtimeApiPath: string): string[] {
  ...
  const removedLineRuntimeSpecifier = ["enclawed", "plugin-sdk", "line-runtime"].join("/");
...
describe("line setup wizard", () => {
  ...
  it("reports account-scoped config keys for named accounts", async () => {
    expect(lineSetupWizard.dmPolicy?.resolveConfigKeys?.({} as EnclawedConfig, "work")).toEqual({
