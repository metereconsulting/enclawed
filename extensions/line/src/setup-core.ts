import type { ChannelSetupAdapter, EnclawedConfig } from "@enclawed/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "@enclawed/plugin-sdk/setup";
...
export function isLineConfigured(cfg: EnclawedConfig, accountId: string): boolean {
