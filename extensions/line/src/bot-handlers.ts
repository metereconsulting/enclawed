...
import { hasControlCommand, resolveControlCommandGate } from "@enclawed/plugin-sdk/command-auth";
...
import { evaluateMatchedGroupAccessForPolicy } from "@enclawed/plugin-sdk/group-access";
