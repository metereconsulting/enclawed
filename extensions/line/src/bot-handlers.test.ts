...
vi.mock("@enclawed/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("@enclawed/plugin-sdk/channel-pairing", () => ({
...
vi.mock("@enclawed/plugin-sdk/command-auth", () => ({
...
vi.mock("@enclawed/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("@enclawed/plugin-sdk/group-access", () => ({
...
vi.mock("@enclawed/plugin-sdk/routing", () => ({
