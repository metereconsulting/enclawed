...
type RegisteredLineCardCommand = Parameters<EnclawedPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: EnclawedPluginApi): Promise<RegisteredLineCardCommand> {
