import { callGatewayTool } from "@enclawed/plugin-sdk/agent-harness-runtime";
import type {
  AnyAgentTool,
  EnclawedPluginApi,
...
export function createRemindTool(
  toolContext: EnclawedPluginToolContext = {},
...
export function registerRemindTool(api: EnclawedPluginApi): void {
