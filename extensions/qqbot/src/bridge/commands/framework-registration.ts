...
import type { EnclawedPluginApi, PluginCommandContext } from "@enclawed/plugin-sdk/plugin-entry";
...
export function registerQQBotFrameworkCommands(api: EnclawedPluginApi): void {
