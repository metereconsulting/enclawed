...
This package contains the **BlueBubbles external channel plugin** for Enclawed.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `@enclawed/plugin-sdk` helpers.
