...
import { collectIssuesForEnabledAccounts } from "@enclawed/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: enclawed channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
