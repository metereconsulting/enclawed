...
`precise.yml` is Enclawed's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Enclawed paths are excluded by `.gitignore` for build reasons even though
