...
upstream Enclawed repository (MIT-licensed, copyright (c) 2025 Peter Steinberger);
each rule is tied to a real Enclawed GHSA advisory through its metadata, and
...
Because enclawed is a hard fork of Enclawed and ships the entire upstream
Enclawed extension catalog, every rule in this rulepack is a regression
firewall: if a vulnerable shape from a past Enclawed GHSA is reintroduced
