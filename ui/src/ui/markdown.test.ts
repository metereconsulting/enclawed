...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/enclawed");
      expect(html).toContain('<a href="http://github.com/enclawed"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Enclawed中文](https://docs.enclawed.ai)");
      expect(html).toContain('href="https://docs.enclawed.ai"');
      expect(html).toContain("Enclawed中文</a>");
    });
