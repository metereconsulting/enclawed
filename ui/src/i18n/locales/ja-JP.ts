...
export const ja_JP: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "モバイルを使用していますか？ デスクトップで enclawed dashboard --no-open から完全な URL（#token=... を含む）をコピーしてください。",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — enclawed models auth で再認証してください",
