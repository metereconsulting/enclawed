...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.enclawed/enclawed.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von enclawed dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit enclawed models auth erneut authentifizieren",
