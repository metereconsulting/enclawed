...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "enclawed.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde enclawed dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — enclawed models auth ile yeniden kimlik doğrulayın",
