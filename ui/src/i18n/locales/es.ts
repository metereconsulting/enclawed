...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.enclawed/enclawed.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde enclawed dashboard --no-open en tu escritorio.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con enclawed models auth",
